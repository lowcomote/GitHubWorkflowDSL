...
/**
 * This is the item provider adapter for a {@link githubwf.Environment} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class EnvironmentItemProvider 
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 GithubwfPackage.eINSTANCE.getEnvironment_Name(),
				 false,
				 false,
				 false,
	...
	protected void addUrlPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Environment_url_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Environment_url_feature", "_UI_Environment_type"),
				 GithubwfPackage.eINSTANCE.getEnvironment_Url(),
				 false,
				 false,
				 false,
				 ItemPropertyDescriptor.GENERIC_VALUE_IMAGE,
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(GithubwfPackage.eINSTANCE.getEnvironment_Environment());
		}
	...
	protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
		...
		newChildDescriptors.add
			(createChildParameter
				(GithubwfPackage.eINSTANCE.getEnvironment_Environment(),
				 GithubwfFactory.eINSTANCE.createEnvironmentName()));

		newChildDescriptors.add
			(createChildParameter
				(GithubwfPackage.eINSTANCE.getEnvironment_Environment(),
				 GithubwfFactory.eINSTANCE.createEnvironmentUrl()));
	}
