...
/**
 * This is the item provider adapter for a {@link githubwf.Defaults} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class DefaultsItemProvider 
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Defaults_run_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Defaults_run_feature", "_UI_Defaults_type"),
				 GithubwfPackage.eINSTANCE.getDefaults_Run(),
				 false,
				 false,
				 false,
				 null,
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(GithubwfPackage.eINSTANCE.getDefaults_Defaults());
		}
	...
	protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
		...
		newChildDescriptors.add
			(createChildParameter
				(GithubwfPackage.eINSTANCE.getDefaults_Defaults(),
				 GithubwfFactory.eINSTANCE.createDefaultsRun()));
	}
