...
/**
 * <!-- begin-user-doc -->
 * An implementation of the model object '<em><b>Normal Job Continue 45on 45error Type Boolean</b></em>'.
 * <!-- end-user-doc -->
 * <p>
 * The following features are implemented:
 * </p>
 * <ul>
 *   <li>{@link githubwf.impl.NormalJobContinue_45on_45errorTypeBooleanImpl#getContinue_45on_45error <em>Continue 45on 45error</em>}</li>
 * </ul>
 *
 * @generated
 */
public class NormalJobContinue_45on_45errorTypeBooleanImpl extends NormalJobContinue_45on_45errorAbstractImpl implements NormalJobContinue_45on_45errorTypeBoolean {
	/**
	 ...
	 * @generated
	 */
	protected NormalJobContinue_45on_45errorTypeBooleanImpl() {
		super();
	}
	...
	protected EClass eStaticClass() {
		return GithubwfPackage.eINSTANCE.getNormalJobContinue_45on_45errorTypeBoolean();
	}
	...
	public void setContinue_45on_45error(Boolean newContinue_45on_45error) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, GithubwfPackage.NORMAL_JOB_CONTINUE_45ON_45ERROR_TYPE_BOOLEAN__CONTINUE_45ON_45ERROR, oldContinue_45on_45error, continue_45on_45error));
	}
...
} //NormalJobContinue_45on_45errorTypeBooleanImpl
