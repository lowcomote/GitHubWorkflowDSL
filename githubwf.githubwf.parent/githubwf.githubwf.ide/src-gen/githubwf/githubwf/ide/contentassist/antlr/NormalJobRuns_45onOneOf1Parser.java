...
import githubwf.githubwf.ide.contentassist.antlr.internal.InternalNormalJobRuns_45onOneOf1Parser;
import githubwf.githubwf.services.NormalJobRuns_45onOneOf1GrammarAccess;
import java.util.Map;
import org.eclipse.xtext.AbstractElement;
import org.eclipse.xtext.ide.editor.contentassist.antlr.AbstractContentAssistParser;

public class NormalJobRuns_45onOneOf1Parser extends AbstractContentAssistParser {
	...
	public static final class NameMappings {
		...
		@Inject
		public NameMappings(NormalJobRuns_45onOneOf1GrammarAccess grammarAccess) {
		...
		private static void init(ImmutableMap.Builder<AbstractElement, String> builder, NormalJobRuns_45onOneOf1GrammarAccess grammarAccess) {
			...
			builder.put(grammarAccess.getNormalJobRuns_45onOneOf1Access().getGroup(), "rule__NormalJobRuns_45onOneOf1__Group__0");
			builder.put(grammarAccess.getNormalJobRuns_45onOneOf1Access().getGroup_4(), "rule__NormalJobRuns_45onOneOf1__Group_4__0");
			builder.put(grammarAccess.getNormalJobRuns_45onOneOf1Access().getGroup_4_1(), "rule__NormalJobRuns_45onOneOf1__Group_4_1__0");
			...
			builder.put(grammarAccess.getNormalJobRuns_45onOneOf1Access().getRuns_45onAssignment_4_0(), "rule__NormalJobRuns_45onOneOf1__Runs_45onAssignment_4_0");
			builder.put(grammarAccess.getNormalJobRuns_45onOneOf1Access().getRuns_45onAssignment_4_1_1(), "rule__NormalJobRuns_45onOneOf1__Runs_45onAssignment_4_1_1");
			builder.put(grammarAccess.getNormalJobRuns_45onOneOf1ItemsAccess().getItemsAssignment(), "rule__NormalJobRuns_45onOneOf1Items__ItemsAssignment");
	...
	@Override
	protected InternalNormalJobRuns_45onOneOf1Parser createParser() {
		InternalNormalJobRuns_45onOneOf1Parser result = new InternalNormalJobRuns_45onOneOf1Parser(null);
	...
	public NormalJobRuns_45onOneOf1GrammarAccess getGrammarAccess() {
