...
import githubwf.githubwf.ide.contentassist.antlr.internal.InternalNormalJobStrategyMatrixOneOf0Parser;
import githubwf.githubwf.services.NormalJobStrategyMatrixOneOf0GrammarAccess;
import java.util.Map;
import org.eclipse.xtext.AbstractElement;
import org.eclipse.xtext.ide.editor.contentassist.antlr.AbstractContentAssistParser;

public class NormalJobStrategyMatrixOneOf0Parser extends AbstractContentAssistParser {
	...
	public static final class NameMappings {
		...
		@Inject
		public NameMappings(NormalJobStrategyMatrixOneOf0GrammarAccess grammarAccess) {
		...
		private static void init(ImmutableMap.Builder<AbstractElement, String> builder, NormalJobStrategyMatrixOneOf0GrammarAccess grammarAccess) {
			...
			builder.put(grammarAccess.getNormalJobStrategyMatrixOneOf0Access().getGroup(), "rule__NormalJobStrategyMatrixOneOf0__Group__0");
			builder.put(grammarAccess.getNormalJobStrategyMatrixOneOf0Access().getGroup_4(), "rule__NormalJobStrategyMatrixOneOf0__Group_4__0");
			builder.put(grammarAccess.getNormalJobStrategyMatrixOneOf0Access().getGroup_4_1(), "rule__NormalJobStrategyMatrixOneOf0__Group_4_1__0");
			builder.put(grammarAccess.getNormalJobStrategyMatrixOneOf0AdditionalPropertiesAccess().getGroup(), "rule__NormalJobStrategyMatrixOneOf0AdditionalProperties__Group__0");
			...
			builder.put(grammarAccess.getNormalJobStrategyMatrixOneOf0Access().getMatrixAssignment_4_0(), "rule__NormalJobStrategyMatrixOneOf0__MatrixAssignment_4_0");
			builder.put(grammarAccess.getNormalJobStrategyMatrixOneOf0Access().getMatrixAssignment_4_1_1(), "rule__NormalJobStrategyMatrixOneOf0__MatrixAssignment_4_1_1");
			builder.put(grammarAccess.getNormalJobStrategyMatrixOneOf0AdditionalPropertiesAccess().getKeyAssignment_0(), "rule__NormalJobStrategyMatrixOneOf0AdditionalProperties__KeyAssignment_0");
			builder.put(grammarAccess.getNormalJobStrategyMatrixOneOf0AdditionalPropertiesAccess().getAdditionalPropertiesAssignment_2(), "rule__NormalJobStrategyMatrixOneOf0AdditionalProperties__AdditionalPropertiesAssignment_2");
	...
	@Override
	protected InternalNormalJobStrategyMatrixOneOf0Parser createParser() {
		InternalNormalJobStrategyMatrixOneOf0Parser result = new InternalNormalJobStrategyMatrixOneOf0Parser(null);
