...
import githubwf.githubwf.ide.contentassist.antlr.internal.InternalRefOneOf0Parser;
import githubwf.githubwf.services.RefOneOf0GrammarAccess;
import java.util.Map;
import org.eclipse.xtext.AbstractElement;
import org.eclipse.xtext.ide.editor.contentassist.antlr.AbstractContentAssistParser;

public class RefOneOf0Parser extends AbstractContentAssistParser {
	...
	public static final class NameMappings {
		...
		@Inject
		public NameMappings(RefOneOf0GrammarAccess grammarAccess) {
		...
		private static void init(ImmutableMap.Builder<AbstractElement, String> builder, RefOneOf0GrammarAccess grammarAccess) {
			builder.put(grammarAccess.getValueAccess().getAlternatives(), "rule__Value__Alternatives");
			builder.put(grammarAccess.getEDoubleAccess().getAlternatives(), "rule__EDouble__Alternatives");
			builder.put(grammarAccess.getEBooleanAccess().getAlternatives(), "rule__EBoolean__Alternatives");
			builder.put(grammarAccess.getRefOneOf0Access().getGroup(), "rule__RefOneOf0__Group__0");
			builder.put(grammarAccess.getRefOneOf0Access().getGroup_2(), "rule__RefOneOf0__Group_2__0");
			builder.put(grammarAccess.getRefOneOf0Access().getGroup_2_1(), "rule__RefOneOf0__Group_2_1__0");
			builder.put(grammarAccess.getRefOneOf0AdditionalPropertiesAccess().getGroup(), "rule__RefOneOf0AdditionalProperties__Group__0");
			...
			builder.put(grammarAccess.getRefOneOf0Access().getRefAssignment_2_0(), "rule__RefOneOf0__RefAssignment_2_0");
			builder.put(grammarAccess.getRefOneOf0Access().getRefAssignment_2_1_1(), "rule__RefOneOf0__RefAssignment_2_1_1");
			builder.put(grammarAccess.getRefOneOf0AdditionalPropertiesAccess().getKeyAssignment_0(), "rule__RefOneOf0AdditionalProperties__KeyAssignment_0");
			builder.put(grammarAccess.getRefOneOf0AdditionalPropertiesAccess().getAdditionalPropertiesAssignment_2(), "rule__RefOneOf0AdditionalProperties__AdditionalPropertiesAssignment_2");
	...
	@Override
	protected InternalRefOneOf0Parser createParser() {
		InternalRefOneOf0Parser result = new InternalRefOneOf0Parser(null);
