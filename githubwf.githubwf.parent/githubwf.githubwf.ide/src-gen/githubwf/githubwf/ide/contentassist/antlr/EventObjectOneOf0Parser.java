...
import githubwf.githubwf.ide.contentassist.antlr.internal.InternalEventObjectOneOf0Parser;
import githubwf.githubwf.services.EventObjectOneOf0GrammarAccess;
import java.util.Map;
import org.eclipse.xtext.AbstractElement;
import org.eclipse.xtext.ide.editor.contentassist.antlr.AbstractContentAssistParser;

public class EventObjectOneOf0Parser extends AbstractContentAssistParser {
	...
	public static final class NameMappings {
		...
		@Inject
		public NameMappings(EventObjectOneOf0GrammarAccess grammarAccess) {
		...
		private static void init(ImmutableMap.Builder<AbstractElement, String> builder, EventObjectOneOf0GrammarAccess grammarAccess) {
			builder.put(grammarAccess.getValueAccess().getAlternatives(), "rule__Value__Alternatives");
			builder.put(grammarAccess.getEDoubleAccess().getAlternatives(), "rule__EDouble__Alternatives");
			builder.put(grammarAccess.getEBooleanAccess().getAlternatives(), "rule__EBoolean__Alternatives");
			builder.put(grammarAccess.getEventObjectOneOf0Access().getGroup(), "rule__EventObjectOneOf0__Group__0");
			builder.put(grammarAccess.getEventObjectOneOf0Access().getGroup_2(), "rule__EventObjectOneOf0__Group_2__0");
			builder.put(grammarAccess.getEventObjectOneOf0Access().getGroup_2_1(), "rule__EventObjectOneOf0__Group_2_1__0");
			builder.put(grammarAccess.getEventObjectOneOf0AdditionalPropertiesAccess().getGroup(), "rule__EventObjectOneOf0AdditionalProperties__Group__0");
			...
			builder.put(grammarAccess.getEventObjectOneOf0Access().getEventObjectAssignment_2_0(), "rule__EventObjectOneOf0__EventObjectAssignment_2_0");
			builder.put(grammarAccess.getEventObjectOneOf0Access().getEventObjectAssignment_2_1_1(), "rule__EventObjectOneOf0__EventObjectAssignment_2_1_1");
			builder.put(grammarAccess.getEventObjectOneOf0AdditionalPropertiesAccess().getKeyAssignment_0(), "rule__EventObjectOneOf0AdditionalProperties__KeyAssignment_0");
			builder.put(grammarAccess.getEventObjectOneOf0AdditionalPropertiesAccess().getAdditionalPropertiesAssignment_2(), "rule__EventObjectOneOf0AdditionalProperties__AdditionalPropertiesAssignment_2");
	...
	@Override
	protected InternalEventObjectOneOf0Parser createParser() {
		InternalEventObjectOneOf0Parser result = new InternalEventObjectOneOf0Parser(null);
