...
import githubwf.githubwf.ide.contentassist.antlr.internal.InternalReusableWorkflowCallJobSecretsOneOf1Parser;
import githubwf.githubwf.services.ReusableWorkflowCallJobSecretsOneOf1GrammarAccess;
import java.util.Map;
import org.eclipse.xtext.AbstractElement;
import org.eclipse.xtext.ide.editor.contentassist.antlr.AbstractContentAssistParser;

public class ReusableWorkflowCallJobSecretsOneOf1Parser extends AbstractContentAssistParser {
	...
	public static final class NameMappings {
		...
		@Inject
		public NameMappings(ReusableWorkflowCallJobSecretsOneOf1GrammarAccess grammarAccess) {
		...
		private static void init(ImmutableMap.Builder<AbstractElement, String> builder, ReusableWorkflowCallJobSecretsOneOf1GrammarAccess grammarAccess) {
			...
			builder.put(grammarAccess.getReusableWorkflowCallJobSecretsOneOf1Access().getGroup(), "rule__ReusableWorkflowCallJobSecretsOneOf1__Group__0");
			...
			builder.put(grammarAccess.getReusableWorkflowCallJobSecretsOneOf1Access().getSecretsAssignment_2(), "rule__ReusableWorkflowCallJobSecretsOneOf1__SecretsAssignment_2");
	...
	@Override
	protected InternalReusableWorkflowCallJobSecretsOneOf1Parser createParser() {
		InternalReusableWorkflowCallJobSecretsOneOf1Parser result = new InternalReusableWorkflowCallJobSecretsOneOf1Parser(null);
