 ...
 */
parser grammar InternalRefOneOf0Parser;

options {
	tokenVocab=InternalRefOneOf0Lexer;
...
// Entry rule entryRuleRefOneOf0PropertiesAbstract
entryRuleRefOneOf0PropertiesAbstract
:
...
// Rule RefOneOf0PropertiesAbstract
ruleRefOneOf0PropertiesAbstract 
	@init {
		int stackSize = keepStackSize();
	}
...
// Entry rule entryRuleRefOneOf0AdditionalProperties
entryRuleRefOneOf0AdditionalProperties
:
...
// Rule RefOneOf0AdditionalProperties
ruleRefOneOf0AdditionalProperties 
	@init {
		int stackSize = keepStackSize();
	}
