 ...
 */
parser grammar InternalReusableWorkflowCallJobStrategyMatrixOneOf0Parser;

options {
	tokenVocab=InternalReusableWorkflowCallJobStrategyMatrixOneOf0Lexer;
...
// Entry rule entryRuleReusableWorkflowCallJobStrategyMatrixOneOf0
entryRuleReusableWorkflowCallJobStrategyMatrixOneOf0 returns [EObject current=null]:
	...
	{ $current=$iv_ruleReusableWorkflowCallJobStrategyMatrixOneOf0.current; }
	EOF;

// Rule ReusableWorkflowCallJobStrategyMatrixOneOf0
ruleReusableWorkflowCallJobStrategyMatrixOneOf0 returns [EObject current=null]
@init {
	enterRule();
}
@after {
...
// Entry rule entryRuleReusableWorkflowCallJobStrategyMatrixOneOf0PropertiesAbstract
entryRuleReusableWorkflowCallJobStrategyMatrixOneOf0PropertiesAbstract returns [EObject current=null]:
	...
	{ $current=$iv_ruleReusableWorkflowCallJobStrategyMatrixOneOf0PropertiesAbstract.current; }
	EOF;

// Rule ReusableWorkflowCallJobStrategyMatrixOneOf0PropertiesAbstract
ruleReusableWorkflowCallJobStrategyMatrixOneOf0PropertiesAbstract returns [EObject current=null]
@init {
	enterRule();
}
@after {
	...
	(
		...
		{
			$current = $this_ReusableWorkflowCallJobStrategyMatrixOneOf0AdditionalProperties_0.current;
			afterParserOrEnumRuleCall();
		}
	)
;
...
// Entry rule entryRuleReusableWorkflowCallJobStrategyMatrixOneOf0AdditionalProperties
entryRuleReusableWorkflowCallJobStrategyMatrixOneOf0AdditionalProperties returns [EObject current=null]:
	...
	{ $current=$iv_ruleReusableWorkflowCallJobStrategyMatrixOneOf0AdditionalProperties.current; }
	EOF;

// Rule ReusableWorkflowCallJobStrategyMatrixOneOf0AdditionalProperties
ruleReusableWorkflowCallJobStrategyMatrixOneOf0AdditionalProperties returns [EObject current=null]
@init {
	enterRule();
}
@after {
