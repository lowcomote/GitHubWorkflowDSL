...
entryRuleRefOneOf0 returns [EObject current=null]:
	{ newCompositeNode(grammarAccess.getRefOneOf0Rule()); }
	iv_ruleRefOneOf0=ruleRefOneOf0
	{ $current=$iv_ruleRefOneOf0.current; }
	EOF;

// Rule RefOneOf0
ruleRefOneOf0 returns [EObject current=null]
@init {
	enterRule();
}
@after {
...
entryRuleRefOneOf0PropertiesAbstract returns [EObject current=null]:
	...
	{ $current=$iv_ruleRefOneOf0PropertiesAbstract.current; }
	EOF;

// Rule RefOneOf0PropertiesAbstract
ruleRefOneOf0PropertiesAbstract returns [EObject current=null]
@init {
	enterRule();
}
@after {
	...
	(
		...
		{
			$current = $this_RefOneOf0AdditionalProperties_0.current;
			afterParserOrEnumRuleCall();
		}
	)
;
...
entryRuleRefOneOf0AdditionalProperties returns [EObject current=null]:
	...
	{ $current=$iv_ruleRefOneOf0AdditionalProperties.current; }
	EOF;

// Rule RefOneOf0AdditionalProperties
ruleRefOneOf0AdditionalProperties returns [EObject current=null]
@init {
	enterRule();
}
@after {
