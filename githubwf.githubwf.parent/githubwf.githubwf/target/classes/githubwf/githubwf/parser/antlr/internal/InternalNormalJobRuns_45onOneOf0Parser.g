...
entryRuleNormalJobRuns_45onOneOf0 returns [EObject current=null]:
	...
	{ $current=$iv_ruleNormalJobRuns_45onOneOf0.current; }
	EOF;

// Rule NormalJobRuns_45onOneOf0
ruleNormalJobRuns_45onOneOf0 returns [EObject current=null]
@init {
	enterRule();
}
@after {
