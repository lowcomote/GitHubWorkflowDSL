 ...
 */
parser grammar InternalNormalJobRuns_45onOneOf1Parser;

options {
	tokenVocab=InternalNormalJobRuns_45onOneOf1Lexer;
...
// Entry rule entryRuleNormalJobRuns_45onOneOf1
entryRuleNormalJobRuns_45onOneOf1 returns [EObject current=null]:
	...
	{ $current=$iv_ruleNormalJobRuns_45onOneOf1.current; }
	EOF;

// Rule NormalJobRuns_45onOneOf1
ruleNormalJobRuns_45onOneOf1 returns [EObject current=null]
@init {
	enterRule();
}
@after {
...
// Entry rule entryRuleNormalJobRuns_45onOneOf1Items
entryRuleNormalJobRuns_45onOneOf1Items returns [EObject current=null]:
	...
	{ $current=$iv_ruleNormalJobRuns_45onOneOf1Items.current; }
	EOF;

// Rule NormalJobRuns_45onOneOf1Items
ruleNormalJobRuns_45onOneOf1Items returns [EObject current=null]
@init {
	enterRule();
}
@after {
