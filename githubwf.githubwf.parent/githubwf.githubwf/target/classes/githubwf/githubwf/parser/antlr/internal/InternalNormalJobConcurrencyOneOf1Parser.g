...
entryRuleNormalJobConcurrencyOneOf1 returns [EObject current=null]:
	...
	{ $current=$iv_ruleNormalJobConcurrencyOneOf1.current; }
	EOF;

// Rule NormalJobConcurrencyOneOf1
ruleNormalJobConcurrencyOneOf1 returns [EObject current=null]
@init {
	enterRule();
}
@after {
