...
entryRuleNormalJobStrategyMatrixOneOf0 returns [EObject current=null]:
	...
	{ $current=$iv_ruleNormalJobStrategyMatrixOneOf0.current; }
	EOF;

// Rule NormalJobStrategyMatrixOneOf0
ruleNormalJobStrategyMatrixOneOf0 returns [EObject current=null]
@init {
	enterRule();
}
@after {
...
entryRuleNormalJobStrategyMatrixOneOf0PropertiesAbstract returns [EObject current=null]:
	...
	{ $current=$iv_ruleNormalJobStrategyMatrixOneOf0PropertiesAbstract.current; }
	EOF;

// Rule NormalJobStrategyMatrixOneOf0PropertiesAbstract
ruleNormalJobStrategyMatrixOneOf0PropertiesAbstract returns [EObject current=null]
@init {
	enterRule();
}
@after {
	...
	(
		...
		{
			$current = $this_NormalJobStrategyMatrixOneOf0AdditionalProperties_0.current;
			afterParserOrEnumRuleCall();
		}
	)
;
...
entryRuleNormalJobStrategyMatrixOneOf0AdditionalProperties returns [EObject current=null]:
	...
	{ $current=$iv_ruleNormalJobStrategyMatrixOneOf0AdditionalProperties.current; }
	EOF;

// Rule NormalJobStrategyMatrixOneOf0AdditionalProperties
ruleNormalJobStrategyMatrixOneOf0AdditionalProperties returns [EObject current=null]
@init {
	enterRule();
}
@after {
