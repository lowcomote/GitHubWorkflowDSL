...
entryRuleGithubwfRootConcurrencyOneOf1 returns [EObject current=null]:
	...
	{ $current=$iv_ruleGithubwfRootConcurrencyOneOf1.current; }
	EOF;

// Rule GithubwfRootConcurrencyOneOf1
ruleGithubwfRootConcurrencyOneOf1 returns [EObject current=null]
@init {
	enterRule();
}
@after {
