...
public class NormalJobStrategyMatrixAdditionalPropertiesOneOf0Validator extends AbstractNormalJobStrategyMatrixAdditionalPropertiesOneOf0Validator {
	
	@Inject githubwf.githubwf.services.NormalJobStrategyMatrixAdditionalPropertiesOneOf0GrammarAccess grammarAccess;	
	...
	private void independentValidation(String eClassName, List<EObject> processedListName, InputStream inputStream){
		try {
			Method getRule = githubwf.githubwf.services.NormalJobStrategyMatrixAdditionalPropertiesOneOf0GrammarAccess.class.getDeclaredMethod("get"+eClassName+"Rule");
			...
			Thread validationThread = new Thread(new Runnable() {
			    ...
			    public void run() {
			    	try {
						URI uri=URI.createURI("platform:/dummy.normaljobstrategymatrixadditionalpropertiesoneof0");
