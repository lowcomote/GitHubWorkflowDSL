...
public class NormalJobStrategyMatrixAdditionalPropertiesOneOf1Validator extends AbstractNormalJobStrategyMatrixAdditionalPropertiesOneOf1Validator {
	
	@Inject githubwf.githubwf.services.NormalJobStrategyMatrixAdditionalPropertiesOneOf1GrammarAccess grammarAccess;	
	...
	private void independentValidation(String eClassName, List<EObject> processedListName, InputStream inputStream){
		try {
			Method getRule = githubwf.githubwf.services.NormalJobStrategyMatrixAdditionalPropertiesOneOf1GrammarAccess.class.getDeclaredMethod("get"+eClassName+"Rule");
			...
			Thread validationThread = new Thread(new Runnable() {
			    ...
			    public void run() {
			    	try {
						URI uri=URI.createURI("platform:/dummy.normaljobstrategymatrixadditionalpropertiesoneof1");
