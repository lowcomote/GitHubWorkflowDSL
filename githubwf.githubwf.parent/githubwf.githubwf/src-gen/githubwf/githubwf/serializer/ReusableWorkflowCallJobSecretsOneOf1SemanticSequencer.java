...
public class ReusableWorkflowCallJobSecretsOneOf1SemanticSequencer extends AbstractDelegatingSemanticSequencer {
	...
	public void sequence(ISerializationContext context, EObject semanticObject) {
		...
		if (epackage == GithubwfPackage.eINSTANCE)
			...
			case GithubwfPackage.REUSABLE_WORKFLOW_CALL_JOB_SECRETS_ONE_OF1:
				sequence_ReusableWorkflowCallJobSecretsOneOf1(context, (ReusableWorkflowCallJobSecretsOneOf1) semanticObject); 
				return; 
			}
	 ...
	 */
	protected void sequence_ReusableWorkflowCallJobSecretsOneOf1(ISerializationContext context, ReusableWorkflowCallJobSecretsOneOf1 semanticObject) {
		if (errorAcceptor != null) {
			if (transientValues.isValueTransient(semanticObject, GithubwfPackage.eINSTANCE.getReusableWorkflowCallJobSecretsOneOf1_Secrets()) == ValueTransient.YES)
				errorAcceptor.accept(diagnosticProvider.createFeatureValueMissing(semanticObject, GithubwfPackage.eINSTANCE.getReusableWorkflowCallJobSecretsOneOf1_Secrets()));
		}
		SequenceFeeder feeder = createSequencerFeeder(context, semanticObject);
		feeder.accept(grammarAccess.getReusableWorkflowCallJobSecretsOneOf1Access().getSecretsJsonDocumentParserRuleCall_2_0(), semanticObject.getSecrets());
		feeder.finish();
	}
