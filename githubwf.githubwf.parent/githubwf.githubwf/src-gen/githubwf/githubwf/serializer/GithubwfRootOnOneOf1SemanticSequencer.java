...
public class GithubwfRootOnOneOf1SemanticSequencer extends AbstractDelegatingSemanticSequencer {
	...
	public void sequence(ISerializationContext context, EObject semanticObject) {
		...
		if (epackage == GithubwfPackage.eINSTANCE)
			...
			case GithubwfPackage.EVENT:
				...
				return; 
			case GithubwfPackage.GITHUBWF_ROOT_ON_ONE_OF1:
				sequence_GithubwfRootOnOneOf1(context, (GithubwfRootOnOneOf1) semanticObject); 
				return; 
			case GithubwfPackage.GITHUBWF_ROOT_ON_ONE_OF1_ITEMS:
				sequence_GithubwfRootOnOneOf1Items(context, (GithubwfRootOnOneOf1Items) semanticObject); 
				return; 
			}
	 ...
	 *     items=Event
	 */
	protected void sequence_GithubwfRootOnOneOf1Items(ISerializationContext context, GithubwfRootOnOneOf1Items semanticObject) {
		if (errorAcceptor != null) {
			if (transientValues.isValueTransient(semanticObject, GithubwfPackage.eINSTANCE.getGithubwfRootOnOneOf1Items_Items()) == ValueTransient.YES)
				errorAcceptor.accept(diagnosticProvider.createFeatureValueMissing(semanticObject, GithubwfPackage.eINSTANCE.getGithubwfRootOnOneOf1Items_Items()));
		}
		SequenceFeeder feeder = createSequencerFeeder(context, semanticObject);
		feeder.accept(grammarAccess.getGithubwfRootOnOneOf1ItemsAccess().getItemsEventParserRuleCall_0(), semanticObject.getItems());
		feeder.finish();
	}
	 ...
	 */
	protected void sequence_GithubwfRootOnOneOf1(ISerializationContext context, GithubwfRootOnOneOf1 semanticObject) {
		genericSequencer.createSequence(context, semanticObject);
	}
