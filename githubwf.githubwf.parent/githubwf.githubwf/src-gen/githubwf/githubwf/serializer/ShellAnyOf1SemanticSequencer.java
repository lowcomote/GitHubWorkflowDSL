...
public class ShellAnyOf1SemanticSequencer extends AbstractDelegatingSemanticSequencer {
	...
	public void sequence(ISerializationContext context, EObject semanticObject) {
		...
		if (epackage == GithubwfPackage.eINSTANCE)
			...
			case GithubwfPackage.SHELL_ANY_OF1:
				sequence_ShellAnyOf1(context, (ShellAnyOf1) semanticObject); 
				return; 
			}
	 ...
	 * </pre>
	 */
	protected void sequence_ShellAnyOf1(ISerializationContext context, ShellAnyOf1 semanticObject) {
		if (errorAcceptor != null) {
			if (transientValues.isValueTransient(semanticObject, GithubwfPackage.eINSTANCE.getShellAnyOf1_Shell()) == ValueTransient.YES)
				errorAcceptor.accept(diagnosticProvider.createFeatureValueMissing(semanticObject, GithubwfPackage.eINSTANCE.getShellAnyOf1_Shell()));
		}
		SequenceFeeder feeder = createSequencerFeeder(context, semanticObject);
		feeder.accept(grammarAccess.getShellAnyOf1Access().getShellJsonDocumentParserRuleCall_0(), semanticObject.getShell());
		feeder.finish();
	}
