...
public class EventObjectOneOf0SemanticSequencer extends AbstractDelegatingSemanticSequencer {
	...
	public void sequence(ISerializationContext context, EObject semanticObject) {
		...
		if (epackage == GithubwfPackage.eINSTANCE)
			...
			case GithubwfPackage.EVENT_OBJECT_ONE_OF0:
				sequence_EventObjectOneOf0(context, (EventObjectOneOf0) semanticObject); 
				return; 
			case GithubwfPackage.EVENT_OBJECT_ONE_OF0_ADDITIONAL_PROPERTIES:
				sequence_EventObjectOneOf0AdditionalProperties(context, (EventObjectOneOf0AdditionalProperties) semanticObject); 
				return; 
			}
	 ...
	 * <pre>
	 * Contexts:
	 *     EventObjectOneOf0PropertiesAbstract returns EventObjectOneOf0AdditionalProperties
	 ...
	 * </pre>
	 */
	protected void sequence_EventObjectOneOf0AdditionalProperties(ISerializationContext context, EventObjectOneOf0AdditionalProperties semanticObject) {
		if (errorAcceptor != null) {
			if (transientValues.isValueTransient(semanticObject, GithubwfPackage.eINSTANCE.getEventObjectOneOf0AdditionalProperties_Key()) == ValueTransient.YES)
				errorAcceptor.accept(diagnosticProvider.createFeatureValueMissing(semanticObject, GithubwfPackage.eINSTANCE.getEventObjectOneOf0AdditionalProperties_Key()));
			if (transientValues.isValueTransient(semanticObject, GithubwfPackage.eINSTANCE.getEventObjectOneOf0AdditionalProperties_AdditionalProperties()) == ValueTransient.YES)
				errorAcceptor.accept(diagnosticProvider.createFeatureValueMissing(semanticObject, GithubwfPackage.eINSTANCE.getEventObjectOneOf0AdditionalProperties_AdditionalProperties()));
		}
		SequenceFeeder feeder = createSequencerFeeder(context, semanticObject);
		feeder.accept(grammarAccess.getEventObjectOneOf0AdditionalPropertiesAccess().getKeyEStringParserRuleCall_0_0(), semanticObject.getKey());
		feeder.accept(grammarAccess.getEventObjectOneOf0AdditionalPropertiesAccess().getAdditionalPropertiesJsonDocumentParserRuleCall_2_0(), semanticObject.getAdditionalProperties());
		feeder.finish();
	}
	 ...
	 * </pre>
	 */
	protected void sequence_EventObjectOneOf0(ISerializationContext context, EventObjectOneOf0 semanticObject) {
		genericSequencer.createSequence(context, semanticObject);
	}
