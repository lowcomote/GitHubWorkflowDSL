...
public class NormalJobRuns_45onOneOf0SemanticSequencer extends AbstractDelegatingSemanticSequencer {
	...
	public void sequence(ISerializationContext context, EObject semanticObject) {
		...
		if (epackage == GithubwfPackage.eINSTANCE)
			...
			case GithubwfPackage.NORMAL_JOB_RUNS_45ON_ONE_OF0:
				sequence_NormalJobRuns_45onOneOf0(context, (NormalJobRuns_45onOneOf0) semanticObject); 
				return; 
			}
	 ...
	 */
	protected void sequence_NormalJobRuns_45onOneOf0(ISerializationContext context, NormalJobRuns_45onOneOf0 semanticObject) {
		if (errorAcceptor != null) {
			if (transientValues.isValueTransient(semanticObject, GithubwfPackage.eINSTANCE.getNormalJobRuns_45onOneOf0_Runs_45on()) == ValueTransient.YES)
				errorAcceptor.accept(diagnosticProvider.createFeatureValueMissing(semanticObject, GithubwfPackage.eINSTANCE.getNormalJobRuns_45onOneOf0_Runs_45on()));
		}
		SequenceFeeder feeder = createSequencerFeeder(context, semanticObject);
		feeder.accept(grammarAccess.getNormalJobRuns_45onOneOf0Access().getRuns_45onJsonDocumentParserRuleCall_2_0(), semanticObject.getRuns_45on());
		feeder.finish();
	}
