...
public class RefOneOf0SemanticSequencer extends AbstractDelegatingSemanticSequencer {
	...
	public void sequence(ISerializationContext context, EObject semanticObject) {
		...
		if (epackage == GithubwfPackage.eINSTANCE)
			...
			case GithubwfPackage.REF_ONE_OF0:
				sequence_RefOneOf0(context, (RefOneOf0) semanticObject); 
				return; 
			case GithubwfPackage.REF_ONE_OF0_ADDITIONAL_PROPERTIES:
				sequence_RefOneOf0AdditionalProperties(context, (RefOneOf0AdditionalProperties) semanticObject); 
				return; 
			}
	...
	/**
	 * Contexts:
	 *     RefOneOf0PropertiesAbstract returns RefOneOf0AdditionalProperties
	 *     RefOneOf0AdditionalProperties returns RefOneOf0AdditionalProperties
	 *
	 * Constraint:
	 *     (key=EString additionalProperties=JsonDocument)
	 */
	protected void sequence_RefOneOf0AdditionalProperties(ISerializationContext context, RefOneOf0AdditionalProperties semanticObject) {
		if (errorAcceptor != null) {
			if (transientValues.isValueTransient(semanticObject, GithubwfPackage.eINSTANCE.getRefOneOf0AdditionalProperties_Key()) == ValueTransient.YES)
				errorAcceptor.accept(diagnosticProvider.createFeatureValueMissing(semanticObject, GithubwfPackage.eINSTANCE.getRefOneOf0AdditionalProperties_Key()));
			if (transientValues.isValueTransient(semanticObject, GithubwfPackage.eINSTANCE.getRefOneOf0AdditionalProperties_AdditionalProperties()) == ValueTransient.YES)
				errorAcceptor.accept(diagnosticProvider.createFeatureValueMissing(semanticObject, GithubwfPackage.eINSTANCE.getRefOneOf0AdditionalProperties_AdditionalProperties()));
		}
		SequenceFeeder feeder = createSequencerFeeder(context, semanticObject);
		feeder.accept(grammarAccess.getRefOneOf0AdditionalPropertiesAccess().getKeyEStringParserRuleCall_0_0(), semanticObject.getKey());
		feeder.accept(grammarAccess.getRefOneOf0AdditionalPropertiesAccess().getAdditionalPropertiesJsonDocumentParserRuleCall_2_0(), semanticObject.getAdditionalProperties());
		feeder.finish();
	}
	 ...
	 */
	protected void sequence_RefOneOf0(ISerializationContext context, RefOneOf0 semanticObject) {
		genericSequencer.createSequence(context, semanticObject);
	}
