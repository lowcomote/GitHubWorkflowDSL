...
public class NormalJobStrategyMatrixOneOf0SemanticSequencer extends AbstractDelegatingSemanticSequencer {
	...
	public void sequence(ISerializationContext context, EObject semanticObject) {
		...
		if (epackage == GithubwfPackage.eINSTANCE)
			...
			case GithubwfPackage.NORMAL_JOB_STRATEGY_MATRIX_ONE_OF0:
				sequence_NormalJobStrategyMatrixOneOf0(context, (NormalJobStrategyMatrixOneOf0) semanticObject); 
				return; 
			case GithubwfPackage.NORMAL_JOB_STRATEGY_MATRIX_ONE_OF0_ADDITIONAL_PROPERTIES:
				sequence_NormalJobStrategyMatrixOneOf0AdditionalProperties(context, (NormalJobStrategyMatrixOneOf0AdditionalProperties) semanticObject); 
				return; 
			}
	 ...
	 * <pre>
	 * Contexts:
	 *     NormalJobStrategyMatrixOneOf0PropertiesAbstract returns NormalJobStrategyMatrixOneOf0AdditionalProperties
	 ...
	 * </pre>
	 */
	protected void sequence_NormalJobStrategyMatrixOneOf0AdditionalProperties(ISerializationContext context, NormalJobStrategyMatrixOneOf0AdditionalProperties semanticObject) {
		if (errorAcceptor != null) {
			if (transientValues.isValueTransient(semanticObject, GithubwfPackage.eINSTANCE.getNormalJobStrategyMatrixOneOf0AdditionalProperties_Key()) == ValueTransient.YES)
				errorAcceptor.accept(diagnosticProvider.createFeatureValueMissing(semanticObject, GithubwfPackage.eINSTANCE.getNormalJobStrategyMatrixOneOf0AdditionalProperties_Key()));
			if (transientValues.isValueTransient(semanticObject, GithubwfPackage.eINSTANCE.getNormalJobStrategyMatrixOneOf0AdditionalProperties_AdditionalProperties()) == ValueTransient.YES)
				errorAcceptor.accept(diagnosticProvider.createFeatureValueMissing(semanticObject, GithubwfPackage.eINSTANCE.getNormalJobStrategyMatrixOneOf0AdditionalProperties_AdditionalProperties()));
		}
		SequenceFeeder feeder = createSequencerFeeder(context, semanticObject);
		feeder.accept(grammarAccess.getNormalJobStrategyMatrixOneOf0AdditionalPropertiesAccess().getKeyEStringParserRuleCall_0_0(), semanticObject.getKey());
		feeder.accept(grammarAccess.getNormalJobStrategyMatrixOneOf0AdditionalPropertiesAccess().getAdditionalPropertiesJsonDocumentParserRuleCall_2_0(), semanticObject.getAdditionalProperties());
		feeder.finish();
	}
	 ...
	 * </pre>
	 */
	protected void sequence_NormalJobStrategyMatrixOneOf0(ISerializationContext context, NormalJobStrategyMatrixOneOf0 semanticObject) {
		genericSequencer.createSequence(context, semanticObject);
	}
