...
public class NormalJobRuns_45onOneOf1SemanticSequencer extends AbstractDelegatingSemanticSequencer {
	...
	public void sequence(ISerializationContext context, EObject semanticObject) {
		...
		if (epackage == GithubwfPackage.eINSTANCE)
			...
			case GithubwfPackage.NORMAL_JOB_RUNS_45ON_ONE_OF1:
				sequence_NormalJobRuns_45onOneOf1(context, (NormalJobRuns_45onOneOf1) semanticObject); 
				return; 
			case GithubwfPackage.NORMAL_JOB_RUNS_45ON_ONE_OF1_ITEMS:
				sequence_NormalJobRuns_45onOneOf1Items(context, (NormalJobRuns_45onOneOf1Items) semanticObject); 
				return; 
			}
	 ...
	 *     items=JsonDocument
	 */
	protected void sequence_NormalJobRuns_45onOneOf1Items(ISerializationContext context, NormalJobRuns_45onOneOf1Items semanticObject) {
		if (errorAcceptor != null) {
			if (transientValues.isValueTransient(semanticObject, GithubwfPackage.eINSTANCE.getNormalJobRuns_45onOneOf1Items_Items()) == ValueTransient.YES)
				errorAcceptor.accept(diagnosticProvider.createFeatureValueMissing(semanticObject, GithubwfPackage.eINSTANCE.getNormalJobRuns_45onOneOf1Items_Items()));
		}
		SequenceFeeder feeder = createSequencerFeeder(context, semanticObject);
		feeder.accept(grammarAccess.getNormalJobRuns_45onOneOf1ItemsAccess().getItemsJsonDocumentParserRuleCall_0(), semanticObject.getItems());
		feeder.finish();
	}
	 ...
	 */
	protected void sequence_NormalJobRuns_45onOneOf1(ISerializationContext context, NormalJobRuns_45onOneOf1 semanticObject) {
		genericSequencer.createSequence(context, semanticObject);
	}
