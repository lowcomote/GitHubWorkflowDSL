...
public class ReusableWorkflowCallJobStrategyMatrixAdditionalPropertiesOneOf0SemanticSequencer extends AbstractDelegatingSemanticSequencer {
	...
	public void sequence(ISerializationContext context, EObject semanticObject) {
		...
		if (epackage == GithubwfPackage.eINSTANCE)
			...
			case GithubwfPackage.CONFIGURATION_TYPE_STRING:
				...
				return; 
			case GithubwfPackage.REUSABLE_WORKFLOW_CALL_JOB_STRATEGY_MATRIX_ADDITIONAL_PROPERTIES_ONE_OF0:
				sequence_ReusableWorkflowCallJobStrategyMatrixAdditionalPropertiesOneOf0(context, (ReusableWorkflowCallJobStrategyMatrixAdditionalPropertiesOneOf0) semanticObject); 
				return; 
			case GithubwfPackage.REUSABLE_WORKFLOW_CALL_JOB_STRATEGY_MATRIX_ADDITIONAL_PROPERTIES_ONE_OF0_ITEMS:
				sequence_ReusableWorkflowCallJobStrategyMatrixAdditionalPropertiesOneOf0Items(context, (ReusableWorkflowCallJobStrategyMatrixAdditionalPropertiesOneOf0Items) semanticObject); 
				return; 
			}
	 ...
	 * </pre>
	 */
	protected void sequence_ReusableWorkflowCallJobStrategyMatrixAdditionalPropertiesOneOf0Items(ISerializationContext context, ReusableWorkflowCallJobStrategyMatrixAdditionalPropertiesOneOf0Items semanticObject) {
		if (errorAcceptor != null) {
			if (transientValues.isValueTransient(semanticObject, GithubwfPackage.eINSTANCE.getReusableWorkflowCallJobStrategyMatrixAdditionalPropertiesOneOf0Items_Items()) == ValueTransient.YES)
				errorAcceptor.accept(diagnosticProvider.createFeatureValueMissing(semanticObject, GithubwfPackage.eINSTANCE.getReusableWorkflowCallJobStrategyMatrixAdditionalPropertiesOneOf0Items_Items()));
		}
		SequenceFeeder feeder = createSequencerFeeder(context, semanticObject);
		feeder.accept(grammarAccess.getReusableWorkflowCallJobStrategyMatrixAdditionalPropertiesOneOf0ItemsAccess().getItemsConfigurationParserRuleCall_0(), semanticObject.getItems());
		feeder.finish();
	}
	 ...
	 * </pre>
	 */
	protected void sequence_ReusableWorkflowCallJobStrategyMatrixAdditionalPropertiesOneOf0(ISerializationContext context, ReusableWorkflowCallJobStrategyMatrixAdditionalPropertiesOneOf0 semanticObject) {
		genericSequencer.createSequence(context, semanticObject);
	}
