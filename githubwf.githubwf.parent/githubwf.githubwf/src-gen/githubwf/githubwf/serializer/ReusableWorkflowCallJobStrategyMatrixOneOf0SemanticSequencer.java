...
public class ReusableWorkflowCallJobStrategyMatrixOneOf0SemanticSequencer extends AbstractDelegatingSemanticSequencer {
	...
	public void sequence(ISerializationContext context, EObject semanticObject) {
		...
		if (epackage == GithubwfPackage.eINSTANCE)
			...
			case GithubwfPackage.REUSABLE_WORKFLOW_CALL_JOB_STRATEGY_MATRIX_ONE_OF0:
				sequence_ReusableWorkflowCallJobStrategyMatrixOneOf0(context, (ReusableWorkflowCallJobStrategyMatrixOneOf0) semanticObject); 
				return; 
			case GithubwfPackage.REUSABLE_WORKFLOW_CALL_JOB_STRATEGY_MATRIX_ONE_OF0_ADDITIONAL_PROPERTIES:
				sequence_ReusableWorkflowCallJobStrategyMatrixOneOf0AdditionalProperties(context, (ReusableWorkflowCallJobStrategyMatrixOneOf0AdditionalProperties) semanticObject); 
				return; 
			}
	...
	/**
	 * Contexts:
	 *     ReusableWorkflowCallJobStrategyMatrixOneOf0PropertiesAbstract returns ReusableWorkflowCallJobStrategyMatrixOneOf0AdditionalProperties
	 ...
	 */
	protected void sequence_ReusableWorkflowCallJobStrategyMatrixOneOf0AdditionalProperties(ISerializationContext context, ReusableWorkflowCallJobStrategyMatrixOneOf0AdditionalProperties semanticObject) {
		if (errorAcceptor != null) {
			if (transientValues.isValueTransient(semanticObject, GithubwfPackage.eINSTANCE.getReusableWorkflowCallJobStrategyMatrixOneOf0AdditionalProperties_Key()) == ValueTransient.YES)
				errorAcceptor.accept(diagnosticProvider.createFeatureValueMissing(semanticObject, GithubwfPackage.eINSTANCE.getReusableWorkflowCallJobStrategyMatrixOneOf0AdditionalProperties_Key()));
			if (transientValues.isValueTransient(semanticObject, GithubwfPackage.eINSTANCE.getReusableWorkflowCallJobStrategyMatrixOneOf0AdditionalProperties_AdditionalProperties()) == ValueTransient.YES)
				errorAcceptor.accept(diagnosticProvider.createFeatureValueMissing(semanticObject, GithubwfPackage.eINSTANCE.getReusableWorkflowCallJobStrategyMatrixOneOf0AdditionalProperties_AdditionalProperties()));
		}
		SequenceFeeder feeder = createSequencerFeeder(context, semanticObject);
		feeder.accept(grammarAccess.getReusableWorkflowCallJobStrategyMatrixOneOf0AdditionalPropertiesAccess().getKeyEStringParserRuleCall_0_0(), semanticObject.getKey());
		feeder.accept(grammarAccess.getReusableWorkflowCallJobStrategyMatrixOneOf0AdditionalPropertiesAccess().getAdditionalPropertiesJsonDocumentParserRuleCall_2_0(), semanticObject.getAdditionalProperties());
		feeder.finish();
	}
	 ...
	 */
	protected void sequence_ReusableWorkflowCallJobStrategyMatrixOneOf0(ISerializationContext context, ReusableWorkflowCallJobStrategyMatrixOneOf0 semanticObject) {
		genericSequencer.createSequence(context, semanticObject);
	}
