...
public class ConfigurationOneOf3SemanticSequencer extends AbstractDelegatingSemanticSequencer {
	...
	public void sequence(ISerializationContext context, EObject semanticObject) {
		...
		if (epackage == GithubwfPackage.eINSTANCE)
			...
			case GithubwfPackage.CONFIGURATION_ITEMS:
				...
				return; 
			case GithubwfPackage.CONFIGURATION_ONE_OF3:
				sequence_ConfigurationOneOf3(context, (ConfigurationOneOf3) semanticObject); 
				return; 
			case GithubwfPackage.CONFIGURATION_ONE_OF3_ADDITIONAL_PROPERTIES:
				sequence_ConfigurationOneOf3AdditionalProperties(context, (ConfigurationOneOf3AdditionalProperties) semanticObject); 
				return; 
	 ...
	 * <pre>
	 * Contexts:
	 *     ConfigurationOneOf3PropertiesAbstract returns ConfigurationOneOf3AdditionalProperties
	 ...
	 * </pre>
	 */
	protected void sequence_ConfigurationOneOf3AdditionalProperties(ISerializationContext context, ConfigurationOneOf3AdditionalProperties semanticObject) {
		if (errorAcceptor != null) {
			if (transientValues.isValueTransient(semanticObject, GithubwfPackage.eINSTANCE.getConfigurationOneOf3AdditionalProperties_Key()) == ValueTransient.YES)
				errorAcceptor.accept(diagnosticProvider.createFeatureValueMissing(semanticObject, GithubwfPackage.eINSTANCE.getConfigurationOneOf3AdditionalProperties_Key()));
			if (transientValues.isValueTransient(semanticObject, GithubwfPackage.eINSTANCE.getConfigurationOneOf3AdditionalProperties_AdditionalProperties()) == ValueTransient.YES)
				errorAcceptor.accept(diagnosticProvider.createFeatureValueMissing(semanticObject, GithubwfPackage.eINSTANCE.getConfigurationOneOf3AdditionalProperties_AdditionalProperties()));
		}
		SequenceFeeder feeder = createSequencerFeeder(context, semanticObject);
		feeder.accept(grammarAccess.getConfigurationOneOf3AdditionalPropertiesAccess().getKeyEStringParserRuleCall_0_0(), semanticObject.getKey());
		feeder.accept(grammarAccess.getConfigurationOneOf3AdditionalPropertiesAccess().getAdditionalPropertiesConfigurationParserRuleCall_2_0(), semanticObject.getAdditionalProperties());
		feeder.finish();
	}
	 ...
	 * </pre>
	 */
	protected void sequence_ConfigurationOneOf3(ISerializationContext context, ConfigurationOneOf3 semanticObject) {
		genericSequencer.createSequence(context, semanticObject);
	}
