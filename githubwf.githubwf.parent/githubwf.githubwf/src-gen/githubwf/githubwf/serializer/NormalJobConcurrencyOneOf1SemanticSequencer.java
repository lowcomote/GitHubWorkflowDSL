...
public class NormalJobConcurrencyOneOf1SemanticSequencer extends AbstractDelegatingSemanticSequencer {
	...
	public void sequence(ISerializationContext context, EObject semanticObject) {
		...
		if (epackage == GithubwfPackage.eINSTANCE)
			...
			case GithubwfPackage.CONCURRENCY_GROUP:
				...
				return; 
			case GithubwfPackage.NORMAL_JOB_CONCURRENCY_ONE_OF1:
				sequence_NormalJobConcurrencyOneOf1(context, (NormalJobConcurrencyOneOf1) semanticObject); 
				return; 
			}
	 ...
	 */
	protected void sequence_NormalJobConcurrencyOneOf1(ISerializationContext context, NormalJobConcurrencyOneOf1 semanticObject) {
		if (errorAcceptor != null) {
			if (transientValues.isValueTransient(semanticObject, GithubwfPackage.eINSTANCE.getNormalJobConcurrencyOneOf1_Concurrency()) == ValueTransient.YES)
				errorAcceptor.accept(diagnosticProvider.createFeatureValueMissing(semanticObject, GithubwfPackage.eINSTANCE.getNormalJobConcurrencyOneOf1_Concurrency()));
		}
		SequenceFeeder feeder = createSequencerFeeder(context, semanticObject);
		feeder.accept(grammarAccess.getNormalJobConcurrencyOneOf1Access().getConcurrencyConcurrencyParserRuleCall_2_0(), semanticObject.getConcurrency());
		feeder.finish();
	}
