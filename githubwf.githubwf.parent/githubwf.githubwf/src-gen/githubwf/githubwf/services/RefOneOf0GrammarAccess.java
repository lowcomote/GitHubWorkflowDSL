...
@Singleton
public class RefOneOf0GrammarAccess extends AbstractElementFinder.AbstractGrammarElementFinder {
	
	public class RefOneOf0Elements extends AbstractParserRuleElementFinder {
		private final ParserRule rule = (ParserRule) GrammarUtil.findRuleForName(getGrammar(), "githubwf.githubwf.RefOneOf0.RefOneOf0");
		private final Group cGroup = (Group)rule.eContents().get(1);
		private final Action cRefOneOf0Action_0 = (Action)cGroup.eContents().get(0);
		private final Keyword cLeftCurlyBracketKeyword_1 = (Keyword)cGroup.eContents().get(1);
		private final Group cGroup_2 = (Group)cGroup.eContents().get(2);
		private final Assignment cRefAssignment_2_0 = (Assignment)cGroup_2.eContents().get(0);
		private final RuleCall cRefRefOneOf0PropertiesAbstractParserRuleCall_2_0_0 = (RuleCall)cRefAssignment_2_0.eContents().get(0);
		private final Group cGroup_2_1 = (Group)cGroup_2.eContents().get(1);
		private final Keyword cCommaKeyword_2_1_0 = (Keyword)cGroup_2_1.eContents().get(0);
		private final Assignment cRefAssignment_2_1_1 = (Assignment)cGroup_2_1.eContents().get(1);
		private final RuleCall cRefRefOneOf0PropertiesAbstractParserRuleCall_2_1_1_0 = (RuleCall)cRefAssignment_2_1_1.eContents().get(0);
		private final Keyword cRightCurlyBracketKeyword_3 = (Keyword)cGroup.eContents().get(3);
		
		////EClass RefOneOf0
		//RefOneOf0 returns RefOneOf0:
		//    {RefOneOf0}
		//            //EReference is not a keyword
		//            '{'(ref+=RefOneOf0PropertiesAbstract ( "," ref+=RefOneOf0PropertiesAbstract)* )?'}'
		//    ;
		...
		//{RefOneOf0}
		public Action getRefOneOf0Action_0() { return cRefOneOf0Action_0; }
		...
		//ref+=RefOneOf0PropertiesAbstract
		public Assignment getRefAssignment_2_0() { return cRefAssignment_2_0; }
		
		//RefOneOf0PropertiesAbstract
		public RuleCall getRefRefOneOf0PropertiesAbstractParserRuleCall_2_0_0() { return cRefRefOneOf0PropertiesAbstractParserRuleCall_2_0_0; }
		...
		//RefOneOf0PropertiesAbstract
		public RuleCall getRefRefOneOf0PropertiesAbstractParserRuleCall_2_1_1_0() { return cRefRefOneOf0PropertiesAbstractParserRuleCall_2_1_1_0; }
		
		//'}'
		public Keyword getRightCurlyBracketKeyword_3() { return cRightCurlyBracketKeyword_3; }
	}
	public class RefOneOf0PropertiesAbstractElements extends AbstractParserRuleElementFinder {
		private final ParserRule rule = (ParserRule) GrammarUtil.findRuleForName(getGrammar(), "githubwf.githubwf.RefOneOf0.RefOneOf0PropertiesAbstract");
		private final RuleCall cRefOneOf0AdditionalPropertiesParserRuleCall = (RuleCall)rule.eContents().get(1);
		
		//RefOneOf0PropertiesAbstract returns RefOneOf0PropertiesAbstract:
		//    =>RefOneOf0AdditionalProperties;
		@Override public ParserRule getRule() { return rule; }
		
		//=>RefOneOf0AdditionalProperties
		public RuleCall getRefOneOf0AdditionalPropertiesParserRuleCall() { return cRefOneOf0AdditionalPropertiesParserRuleCall; }
	}
	public class ValueElements extends AbstractParserRuleElementFinder {
		private final ParserRule rule = (ParserRule) GrammarUtil.findRuleForName(getGrammar(), "githubwf.githubwf.RefOneOf0.Value");
	...
	public class RefOneOf0AdditionalPropertiesElements extends AbstractParserRuleElementFinder {
		private final ParserRule rule = (ParserRule) GrammarUtil.findRuleForName(getGrammar(), "githubwf.githubwf.RefOneOf0.RefOneOf0AdditionalProperties");
		private final Group cGroup = (Group)rule.eContents().get(1);
		...
		////EClass RefOneOf0AdditionalProperties
		//RefOneOf0AdditionalProperties returns RefOneOf0AdditionalProperties:
		//            //KeyValue
		//            key=EString
		//            ':'
		//            //EReference is not a keyword
	...
	public class EStringElements extends AbstractParserRuleElementFinder {
		private final ParserRule rule = (ParserRule) GrammarUtil.findRuleForName(getGrammar(), "githubwf.githubwf.RefOneOf0.EString");
	...
	public class JsonDocumentElements extends AbstractParserRuleElementFinder {
		private final ParserRule rule = (ParserRule) GrammarUtil.findRuleForName(getGrammar(), "githubwf.githubwf.RefOneOf0.JsonDocument");
	...
	public class StringValueElements extends AbstractParserRuleElementFinder {
		private final ParserRule rule = (ParserRule) GrammarUtil.findRuleForName(getGrammar(), "githubwf.githubwf.RefOneOf0.StringValue");
		private final Assignment cValueAssignment = (Assignment)rule.eContents().get(1);
	...
	public class ArrayValueElements extends AbstractParserRuleElementFinder {
		private final ParserRule rule = (ParserRule) GrammarUtil.findRuleForName(getGrammar(), "githubwf.githubwf.RefOneOf0.ArrayValue");
		private final Group cGroup = (Group)rule.eContents().get(1);
	...
	public class NullValueElements extends AbstractParserRuleElementFinder {
		private final ParserRule rule = (ParserRule) GrammarUtil.findRuleForName(getGrammar(), "githubwf.githubwf.RefOneOf0.NullValue");
		private final Assignment cValueAssignment = (Assignment)rule.eContents().get(1);
	...
	public class NumberValueElements extends AbstractParserRuleElementFinder {
		private final ParserRule rule = (ParserRule) GrammarUtil.findRuleForName(getGrammar(), "githubwf.githubwf.RefOneOf0.NumberValue");
		private final Assignment cValueAssignment = (Assignment)rule.eContents().get(1);
	...
	public class ObjectValueElements extends AbstractParserRuleElementFinder {
		private final ParserRule rule = (ParserRule) GrammarUtil.findRuleForName(getGrammar(), "githubwf.githubwf.RefOneOf0.ObjectValue");
		private final Group cGroup = (Group)rule.eContents().get(1);
	...
	public class BooleanValueElements extends AbstractParserRuleElementFinder {
		private final ParserRule rule = (ParserRule) GrammarUtil.findRuleForName(getGrammar(), "githubwf.githubwf.RefOneOf0.BooleanValue");
		private final Assignment cValueAssignment = (Assignment)rule.eContents().get(1);
	...
	public class EDoubleElements extends AbstractParserRuleElementFinder {
		private final ParserRule rule = (ParserRule) GrammarUtil.findRuleForName(getGrammar(), "githubwf.githubwf.RefOneOf0.EDouble");
		private final Alternatives cAlternatives = (Alternatives)rule.eContents().get(1);
	...
	public class KeyValuePairElements extends AbstractParserRuleElementFinder {
		private final ParserRule rule = (ParserRule) GrammarUtil.findRuleForName(getGrammar(), "githubwf.githubwf.RefOneOf0.KeyValuePair");
		private final Group cGroup = (Group)rule.eContents().get(1);
		private final Assignment cKeyAssignment_0 = (Assignment)cGroup.eContents().get(0);
		private final RuleCall cKeyEStringParserRuleCall_0_0 = (RuleCall)cKeyAssignment_0.eContents().get(0);
		private final Keyword cColonKeyword_1 = (Keyword)cGroup.eContents().get(1);
	...
	public class EBooleanElements extends AbstractParserRuleElementFinder {
		private final ParserRule rule = (ParserRule) GrammarUtil.findRuleForName(getGrammar(), "githubwf.githubwf.RefOneOf0.EBoolean");
		private final Alternatives cAlternatives = (Alternatives)rule.eContents().get(1);
	...
	public class VALID_STRINGElements extends AbstractParserRuleElementFinder {
		private final ParserRule rule = (ParserRule) GrammarUtil.findRuleForName(getGrammar(), "githubwf.githubwf.RefOneOf0.VALID_STRING");
	...
	public class NullEnumElements extends AbstractElementFinder.AbstractEnumRuleElementFinder {
		private final EnumRule rule = (EnumRule) GrammarUtil.findRuleForName(getGrammar(), "githubwf.githubwf.RefOneOf0.NullEnum");
	...
	private final RefOneOf0Elements pRefOneOf0;
	private final RefOneOf0PropertiesAbstractElements pRefOneOf0PropertiesAbstract;
	private final ValueElements pValue;
	private final RefOneOf0AdditionalPropertiesElements pRefOneOf0AdditionalProperties;
	...
	@Inject
	public RefOneOf0GrammarAccess(GrammarProvider grammarProvider,
			TerminalsGrammarAccess gaTerminals) {
		this.grammar = internalFindGrammar(grammarProvider);
		this.gaTerminals = gaTerminals;
		this.pRefOneOf0 = new RefOneOf0Elements();
		this.pRefOneOf0PropertiesAbstract = new RefOneOf0PropertiesAbstractElements();
		this.pValue = new ValueElements();
		this.pRefOneOf0AdditionalProperties = new RefOneOf0AdditionalPropertiesElements();
		...
		this.tINT = (TerminalRule) GrammarUtil.findRuleForName(getGrammar(), "githubwf.githubwf.RefOneOf0.INT");
		this.pVALID_STRING = new VALID_STRINGElements();
		this.tSTRING = (TerminalRule) GrammarUtil.findRuleForName(getGrammar(), "githubwf.githubwf.RefOneOf0.STRING");
		this.tE_INT = (TerminalRule) GrammarUtil.findRuleForName(getGrammar(), "githubwf.githubwf.RefOneOf0.E_INT");
		this.tE_DOUBLE = (TerminalRule) GrammarUtil.findRuleForName(getGrammar(), "githubwf.githubwf.RefOneOf0.E_DOUBLE");
	}
	
	protected Grammar internalFindGrammar(GrammarProvider grammarProvider) {
		Grammar grammar = grammarProvider.getGrammar(this);
		while (grammar != null) {
			if ("githubwf.githubwf.RefOneOf0".equals(grammar.getName())) {
				return grammar;
			}
	...
	//            '{'(ref+=RefOneOf0PropertiesAbstract ( "," ref+=RefOneOf0PropertiesAbstract)* )?'}'
	//    ;
	public RefOneOf0Elements getRefOneOf0Access() {
		return pRefOneOf0;
	}
	
	public ParserRule getRefOneOf0Rule() {
		return getRefOneOf0Access().getRule();
	}
	
	//RefOneOf0PropertiesAbstract returns RefOneOf0PropertiesAbstract:
	//    =>RefOneOf0AdditionalProperties;
	public RefOneOf0PropertiesAbstractElements getRefOneOf0PropertiesAbstractAccess() {
		return pRefOneOf0PropertiesAbstract;
	}
	
	public ParserRule getRefOneOf0PropertiesAbstractRule() {
		return getRefOneOf0PropertiesAbstractAccess().getRule();
	}
	...
	//            additionalProperties=JsonDocument
	//    ;
	public RefOneOf0AdditionalPropertiesElements getRefOneOf0AdditionalPropertiesAccess() {
		return pRefOneOf0AdditionalProperties;
	}
	
	public ParserRule getRefOneOf0AdditionalPropertiesRule() {
		return getRefOneOf0AdditionalPropertiesAccess().getRule();
	}
