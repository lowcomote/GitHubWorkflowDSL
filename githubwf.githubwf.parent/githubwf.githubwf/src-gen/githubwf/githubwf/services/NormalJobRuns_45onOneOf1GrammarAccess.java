...
@Singleton
public class NormalJobRuns_45onOneOf1GrammarAccess extends AbstractElementFinder.AbstractGrammarElementFinder {
	
	public class NormalJobRuns_45onOneOf1Elements extends AbstractParserRuleElementFinder {
		private final ParserRule rule = (ParserRule) GrammarUtil.findRuleForName(getGrammar(), "githubwf.githubwf.NormalJobRuns_45onOneOf1.NormalJobRuns_45onOneOf1");
		private final Group cGroup = (Group)rule.eContents().get(1);
		private final Action cNormalJobRuns_45onOneOf1Action_0 = (Action)cGroup.eContents().get(0);
		...
		private final RuleCall cRuns_45onNormalJobRuns_45onOneOf1ItemsParserRuleCall_4_0_0 = (RuleCall)cRuns_45onAssignment_4_0.eContents().get(0);
		private final Group cGroup_4_1 = (Group)cGroup_4.eContents().get(1);
		private final Keyword cCommaKeyword_4_1_0 = (Keyword)cGroup_4_1.eContents().get(0);
		private final Assignment cRuns_45onAssignment_4_1_1 = (Assignment)cGroup_4_1.eContents().get(1);
		private final RuleCall cRuns_45onNormalJobRuns_45onOneOf1ItemsParserRuleCall_4_1_1_0 = (RuleCall)cRuns_45onAssignment_4_1_1.eContents().get(0);
		private final Keyword cRightSquareBracketKeyword_5 = (Keyword)cGroup.eContents().get(5);
		
		////EClass NormalJobRuns_45onOneOf1
		//NormalJobRuns_45onOneOf1 returns NormalJobRuns_45onOneOf1:
		//    {NormalJobRuns_45onOneOf1}
		//            //Keywords
		//            '"runs-on"' ':'
		//            '['(runs_45on+=NormalJobRuns_45onOneOf1Items ( "," runs_45on+=NormalJobRuns_45onOneOf1Items)* )?']'
		//    ;
		...
		//{NormalJobRuns_45onOneOf1}
		public Action getNormalJobRuns_45onOneOf1Action_0() { return cNormalJobRuns_45onOneOf1Action_0; }
		...
		//runs_45on+=NormalJobRuns_45onOneOf1Items
		public Assignment getRuns_45onAssignment_4_0() { return cRuns_45onAssignment_4_0; }
		
		//NormalJobRuns_45onOneOf1Items
		public RuleCall getRuns_45onNormalJobRuns_45onOneOf1ItemsParserRuleCall_4_0_0() { return cRuns_45onNormalJobRuns_45onOneOf1ItemsParserRuleCall_4_0_0; }
		...
		//NormalJobRuns_45onOneOf1Items
		public RuleCall getRuns_45onNormalJobRuns_45onOneOf1ItemsParserRuleCall_4_1_1_0() { return cRuns_45onNormalJobRuns_45onOneOf1ItemsParserRuleCall_4_1_1_0; }
		
		//']'
		public Keyword getRightSquareBracketKeyword_5() { return cRightSquareBracketKeyword_5; }
	}
	public class ValueElements extends AbstractParserRuleElementFinder {
		private final ParserRule rule = (ParserRule) GrammarUtil.findRuleForName(getGrammar(), "githubwf.githubwf.NormalJobRuns_45onOneOf1.Value");
	...
	public class NormalJobRuns_45onOneOf1ItemsElements extends AbstractParserRuleElementFinder {
		private final ParserRule rule = (ParserRule) GrammarUtil.findRuleForName(getGrammar(), "githubwf.githubwf.NormalJobRuns_45onOneOf1.NormalJobRuns_45onOneOf1Items");
		...
		////EClass NormalJobRuns_45onOneOf1Items
		//NormalJobRuns_45onOneOf1Items returns NormalJobRuns_45onOneOf1Items:
	...
	public class JsonDocumentElements extends AbstractParserRuleElementFinder {
		private final ParserRule rule = (ParserRule) GrammarUtil.findRuleForName(getGrammar(), "githubwf.githubwf.NormalJobRuns_45onOneOf1.JsonDocument");
	...
	public class StringValueElements extends AbstractParserRuleElementFinder {
		private final ParserRule rule = (ParserRule) GrammarUtil.findRuleForName(getGrammar(), "githubwf.githubwf.NormalJobRuns_45onOneOf1.StringValue");
		private final Assignment cValueAssignment = (Assignment)rule.eContents().get(1);
	...
	public class ArrayValueElements extends AbstractParserRuleElementFinder {
		private final ParserRule rule = (ParserRule) GrammarUtil.findRuleForName(getGrammar(), "githubwf.githubwf.NormalJobRuns_45onOneOf1.ArrayValue");
		private final Group cGroup = (Group)rule.eContents().get(1);
	...
	public class NullValueElements extends AbstractParserRuleElementFinder {
		private final ParserRule rule = (ParserRule) GrammarUtil.findRuleForName(getGrammar(), "githubwf.githubwf.NormalJobRuns_45onOneOf1.NullValue");
		private final Assignment cValueAssignment = (Assignment)rule.eContents().get(1);
	...
	public class NumberValueElements extends AbstractParserRuleElementFinder {
		private final ParserRule rule = (ParserRule) GrammarUtil.findRuleForName(getGrammar(), "githubwf.githubwf.NormalJobRuns_45onOneOf1.NumberValue");
		private final Assignment cValueAssignment = (Assignment)rule.eContents().get(1);
	...
	public class ObjectValueElements extends AbstractParserRuleElementFinder {
		private final ParserRule rule = (ParserRule) GrammarUtil.findRuleForName(getGrammar(), "githubwf.githubwf.NormalJobRuns_45onOneOf1.ObjectValue");
		private final Group cGroup = (Group)rule.eContents().get(1);
	...
	public class BooleanValueElements extends AbstractParserRuleElementFinder {
		private final ParserRule rule = (ParserRule) GrammarUtil.findRuleForName(getGrammar(), "githubwf.githubwf.NormalJobRuns_45onOneOf1.BooleanValue");
		private final Assignment cValueAssignment = (Assignment)rule.eContents().get(1);
	...
	public class EStringElements extends AbstractParserRuleElementFinder {
		private final ParserRule rule = (ParserRule) GrammarUtil.findRuleForName(getGrammar(), "githubwf.githubwf.NormalJobRuns_45onOneOf1.EString");
	...
	public class EDoubleElements extends AbstractParserRuleElementFinder {
		private final ParserRule rule = (ParserRule) GrammarUtil.findRuleForName(getGrammar(), "githubwf.githubwf.NormalJobRuns_45onOneOf1.EDouble");
		private final Alternatives cAlternatives = (Alternatives)rule.eContents().get(1);
	...
	public class KeyValuePairElements extends AbstractParserRuleElementFinder {
		private final ParserRule rule = (ParserRule) GrammarUtil.findRuleForName(getGrammar(), "githubwf.githubwf.NormalJobRuns_45onOneOf1.KeyValuePair");
		private final Group cGroup = (Group)rule.eContents().get(1);
	...
	public class EBooleanElements extends AbstractParserRuleElementFinder {
		private final ParserRule rule = (ParserRule) GrammarUtil.findRuleForName(getGrammar(), "githubwf.githubwf.NormalJobRuns_45onOneOf1.EBoolean");
		private final Alternatives cAlternatives = (Alternatives)rule.eContents().get(1);
	...
	public class VALID_STRINGElements extends AbstractParserRuleElementFinder {
		private final ParserRule rule = (ParserRule) GrammarUtil.findRuleForName(getGrammar(), "githubwf.githubwf.NormalJobRuns_45onOneOf1.VALID_STRING");
		private final Alternatives cAlternatives = (Alternatives)rule.eContents().get(1);
	...
	public class KEYWORDElements extends AbstractParserRuleElementFinder {
		private final ParserRule rule = (ParserRule) GrammarUtil.findRuleForName(getGrammar(), "githubwf.githubwf.NormalJobRuns_45onOneOf1.KEYWORD");
	...
	public class NullEnumElements extends AbstractElementFinder.AbstractEnumRuleElementFinder {
		private final EnumRule rule = (EnumRule) GrammarUtil.findRuleForName(getGrammar(), "githubwf.githubwf.NormalJobRuns_45onOneOf1.NullEnum");
	...
	private final NormalJobRuns_45onOneOf1Elements pNormalJobRuns_45onOneOf1;
	private final ValueElements pValue;
	private final NormalJobRuns_45onOneOf1ItemsElements pNormalJobRuns_45onOneOf1Items;
	...
	@Inject
	public NormalJobRuns_45onOneOf1GrammarAccess(GrammarProvider grammarProvider,
			TerminalsGrammarAccess gaTerminals) {
		this.grammar = internalFindGrammar(grammarProvider);
		this.gaTerminals = gaTerminals;
		this.pNormalJobRuns_45onOneOf1 = new NormalJobRuns_45onOneOf1Elements();
		this.pValue = new ValueElements();
		this.pNormalJobRuns_45onOneOf1Items = new NormalJobRuns_45onOneOf1ItemsElements();
		...
		this.tINT = (TerminalRule) GrammarUtil.findRuleForName(getGrammar(), "githubwf.githubwf.NormalJobRuns_45onOneOf1.INT");
		this.pVALID_STRING = new VALID_STRINGElements();
		this.tSTRING = (TerminalRule) GrammarUtil.findRuleForName(getGrammar(), "githubwf.githubwf.NormalJobRuns_45onOneOf1.STRING");
		this.tE_INT = (TerminalRule) GrammarUtil.findRuleForName(getGrammar(), "githubwf.githubwf.NormalJobRuns_45onOneOf1.E_INT");
		this.pKEYWORD = new KEYWORDElements();
		this.tE_DOUBLE = (TerminalRule) GrammarUtil.findRuleForName(getGrammar(), "githubwf.githubwf.NormalJobRuns_45onOneOf1.E_DOUBLE");
	}
	
	protected Grammar internalFindGrammar(GrammarProvider grammarProvider) {
		Grammar grammar = grammarProvider.getGrammar(this);
		while (grammar != null) {
			if ("githubwf.githubwf.NormalJobRuns_45onOneOf1".equals(grammar.getName())) {
				return grammar;
			}
	...
	//            '['(runs_45on+=NormalJobRuns_45onOneOf1Items ( "," runs_45on+=NormalJobRuns_45onOneOf1Items)* )?']'
	//    ;
	public NormalJobRuns_45onOneOf1Elements getNormalJobRuns_45onOneOf1Access() {
		return pNormalJobRuns_45onOneOf1;
	}
	
	public ParserRule getNormalJobRuns_45onOneOf1Rule() {
		return getNormalJobRuns_45onOneOf1Access().getRule();
	}
	...
	//            items=JsonDocument
	//    ;
	public NormalJobRuns_45onOneOf1ItemsElements getNormalJobRuns_45onOneOf1ItemsAccess() {
		return pNormalJobRuns_45onOneOf1Items;
	}
	
	public ParserRule getNormalJobRuns_45onOneOf1ItemsRule() {
		return getNormalJobRuns_45onOneOf1ItemsAccess().getRule();
	}
