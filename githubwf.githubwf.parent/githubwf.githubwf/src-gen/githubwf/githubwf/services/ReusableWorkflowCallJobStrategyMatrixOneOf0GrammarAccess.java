...
@Singleton
public class ReusableWorkflowCallJobStrategyMatrixOneOf0GrammarAccess extends AbstractElementFinder.AbstractGrammarElementFinder {
	
	public class ReusableWorkflowCallJobStrategyMatrixOneOf0Elements extends AbstractParserRuleElementFinder {
		private final ParserRule rule = (ParserRule) GrammarUtil.findRuleForName(getGrammar(), "githubwf.githubwf.ReusableWorkflowCallJobStrategyMatrixOneOf0.ReusableWorkflowCallJobStrategyMatrixOneOf0");
		private final Group cGroup = (Group)rule.eContents().get(1);
		private final Action cReusableWorkflowCallJobStrategyMatrixOneOf0Action_0 = (Action)cGroup.eContents().get(0);
		...
		private final RuleCall cMatrixReusableWorkflowCallJobStrategyMatrixOneOf0PropertiesAbstractParserRuleCall_4_0_0 = (RuleCall)cMatrixAssignment_4_0.eContents().get(0);
		private final Group cGroup_4_1 = (Group)cGroup_4.eContents().get(1);
		private final Keyword cCommaKeyword_4_1_0 = (Keyword)cGroup_4_1.eContents().get(0);
		private final Assignment cMatrixAssignment_4_1_1 = (Assignment)cGroup_4_1.eContents().get(1);
		private final RuleCall cMatrixReusableWorkflowCallJobStrategyMatrixOneOf0PropertiesAbstractParserRuleCall_4_1_1_0 = (RuleCall)cMatrixAssignment_4_1_1.eContents().get(0);
		private final Keyword cRightCurlyBracketKeyword_5 = (Keyword)cGroup.eContents().get(5);
		
		////EClass ReusableWorkflowCallJobStrategyMatrixOneOf0
		//ReusableWorkflowCallJobStrategyMatrixOneOf0 returns ReusableWorkflowCallJobStrategyMatrixOneOf0:
		//    {ReusableWorkflowCallJobStrategyMatrixOneOf0}
		//            //Keywords
		//            '"matrix"' ':'
		//            '{'(matrix+=ReusableWorkflowCallJobStrategyMatrixOneOf0PropertiesAbstract ( "," matrix+=ReusableWorkflowCallJobStrategyMatrixOneOf0PropertiesAbstract)* )?'}'
		//    ;
		...
		//{ReusableWorkflowCallJobStrategyMatrixOneOf0}
		public Action getReusableWorkflowCallJobStrategyMatrixOneOf0Action_0() { return cReusableWorkflowCallJobStrategyMatrixOneOf0Action_0; }
		...
		//matrix+=ReusableWorkflowCallJobStrategyMatrixOneOf0PropertiesAbstract
		public Assignment getMatrixAssignment_4_0() { return cMatrixAssignment_4_0; }
		
		//ReusableWorkflowCallJobStrategyMatrixOneOf0PropertiesAbstract
		public RuleCall getMatrixReusableWorkflowCallJobStrategyMatrixOneOf0PropertiesAbstractParserRuleCall_4_0_0() { return cMatrixReusableWorkflowCallJobStrategyMatrixOneOf0PropertiesAbstractParserRuleCall_4_0_0; }
		...
		//ReusableWorkflowCallJobStrategyMatrixOneOf0PropertiesAbstract
		public RuleCall getMatrixReusableWorkflowCallJobStrategyMatrixOneOf0PropertiesAbstractParserRuleCall_4_1_1_0() { return cMatrixReusableWorkflowCallJobStrategyMatrixOneOf0PropertiesAbstractParserRuleCall_4_1_1_0; }
		
		//'}'
		public Keyword getRightCurlyBracketKeyword_5() { return cRightCurlyBracketKeyword_5; }
	}
	public class ReusableWorkflowCallJobStrategyMatrixOneOf0PropertiesAbstractElements extends AbstractParserRuleElementFinder {
		private final ParserRule rule = (ParserRule) GrammarUtil.findRuleForName(getGrammar(), "githubwf.githubwf.ReusableWorkflowCallJobStrategyMatrixOneOf0.ReusableWorkflowCallJobStrategyMatrixOneOf0PropertiesAbstract");
		private final RuleCall cReusableWorkflowCallJobStrategyMatrixOneOf0AdditionalPropertiesParserRuleCall = (RuleCall)rule.eContents().get(1);
		
		//ReusableWorkflowCallJobStrategyMatrixOneOf0PropertiesAbstract returns ReusableWorkflowCallJobStrategyMatrixOneOf0PropertiesAbstract:
		//    =>ReusableWorkflowCallJobStrategyMatrixOneOf0AdditionalProperties;
		@Override public ParserRule getRule() { return rule; }
		
		//=>ReusableWorkflowCallJobStrategyMatrixOneOf0AdditionalProperties
		public RuleCall getReusableWorkflowCallJobStrategyMatrixOneOf0AdditionalPropertiesParserRuleCall() { return cReusableWorkflowCallJobStrategyMatrixOneOf0AdditionalPropertiesParserRuleCall; }
	}
	public class ValueElements extends AbstractParserRuleElementFinder {
		private final ParserRule rule = (ParserRule) GrammarUtil.findRuleForName(getGrammar(), "githubwf.githubwf.ReusableWorkflowCallJobStrategyMatrixOneOf0.Value");
	...
	public class ReusableWorkflowCallJobStrategyMatrixOneOf0AdditionalPropertiesElements extends AbstractParserRuleElementFinder {
		private final ParserRule rule = (ParserRule) GrammarUtil.findRuleForName(getGrammar(), "githubwf.githubwf.ReusableWorkflowCallJobStrategyMatrixOneOf0.ReusableWorkflowCallJobStrategyMatrixOneOf0AdditionalProperties");
		private final Group cGroup = (Group)rule.eContents().get(1);
		...
		////EClass ReusableWorkflowCallJobStrategyMatrixOneOf0AdditionalProperties
		//ReusableWorkflowCallJobStrategyMatrixOneOf0AdditionalProperties returns ReusableWorkflowCallJobStrategyMatrixOneOf0AdditionalProperties:
		//            //KeyValue
		//            key=EString
		//            ':'
	...
	public class EStringElements extends AbstractParserRuleElementFinder {
		private final ParserRule rule = (ParserRule) GrammarUtil.findRuleForName(getGrammar(), "githubwf.githubwf.ReusableWorkflowCallJobStrategyMatrixOneOf0.EString");
	...
	public class JsonDocumentElements extends AbstractParserRuleElementFinder {
		private final ParserRule rule = (ParserRule) GrammarUtil.findRuleForName(getGrammar(), "githubwf.githubwf.ReusableWorkflowCallJobStrategyMatrixOneOf0.JsonDocument");
	...
	public class StringValueElements extends AbstractParserRuleElementFinder {
		private final ParserRule rule = (ParserRule) GrammarUtil.findRuleForName(getGrammar(), "githubwf.githubwf.ReusableWorkflowCallJobStrategyMatrixOneOf0.StringValue");
		private final Assignment cValueAssignment = (Assignment)rule.eContents().get(1);
	...
	public class ArrayValueElements extends AbstractParserRuleElementFinder {
		private final ParserRule rule = (ParserRule) GrammarUtil.findRuleForName(getGrammar(), "githubwf.githubwf.ReusableWorkflowCallJobStrategyMatrixOneOf0.ArrayValue");
		private final Group cGroup = (Group)rule.eContents().get(1);
	...
	public class NullValueElements extends AbstractParserRuleElementFinder {
		private final ParserRule rule = (ParserRule) GrammarUtil.findRuleForName(getGrammar(), "githubwf.githubwf.ReusableWorkflowCallJobStrategyMatrixOneOf0.NullValue");
		private final Assignment cValueAssignment = (Assignment)rule.eContents().get(1);
	...
	public class NumberValueElements extends AbstractParserRuleElementFinder {
		private final ParserRule rule = (ParserRule) GrammarUtil.findRuleForName(getGrammar(), "githubwf.githubwf.ReusableWorkflowCallJobStrategyMatrixOneOf0.NumberValue");
		private final Assignment cValueAssignment = (Assignment)rule.eContents().get(1);
	...
	public class ObjectValueElements extends AbstractParserRuleElementFinder {
		private final ParserRule rule = (ParserRule) GrammarUtil.findRuleForName(getGrammar(), "githubwf.githubwf.ReusableWorkflowCallJobStrategyMatrixOneOf0.ObjectValue");
		private final Group cGroup = (Group)rule.eContents().get(1);
	...
	public class BooleanValueElements extends AbstractParserRuleElementFinder {
		private final ParserRule rule = (ParserRule) GrammarUtil.findRuleForName(getGrammar(), "githubwf.githubwf.ReusableWorkflowCallJobStrategyMatrixOneOf0.BooleanValue");
		private final Assignment cValueAssignment = (Assignment)rule.eContents().get(1);
	...
	public class EDoubleElements extends AbstractParserRuleElementFinder {
		private final ParserRule rule = (ParserRule) GrammarUtil.findRuleForName(getGrammar(), "githubwf.githubwf.ReusableWorkflowCallJobStrategyMatrixOneOf0.EDouble");
		private final Alternatives cAlternatives = (Alternatives)rule.eContents().get(1);
	...
	public class KeyValuePairElements extends AbstractParserRuleElementFinder {
		private final ParserRule rule = (ParserRule) GrammarUtil.findRuleForName(getGrammar(), "githubwf.githubwf.ReusableWorkflowCallJobStrategyMatrixOneOf0.KeyValuePair");
		private final Group cGroup = (Group)rule.eContents().get(1);
		private final Assignment cKeyAssignment_0 = (Assignment)cGroup.eContents().get(0);
		private final RuleCall cKeyEStringParserRuleCall_0_0 = (RuleCall)cKeyAssignment_0.eContents().get(0);
		private final Keyword cColonKeyword_1 = (Keyword)cGroup.eContents().get(1);
	...
	public class EBooleanElements extends AbstractParserRuleElementFinder {
		private final ParserRule rule = (ParserRule) GrammarUtil.findRuleForName(getGrammar(), "githubwf.githubwf.ReusableWorkflowCallJobStrategyMatrixOneOf0.EBoolean");
		private final Alternatives cAlternatives = (Alternatives)rule.eContents().get(1);
	...
	public class VALID_STRINGElements extends AbstractParserRuleElementFinder {
		private final ParserRule rule = (ParserRule) GrammarUtil.findRuleForName(getGrammar(), "githubwf.githubwf.ReusableWorkflowCallJobStrategyMatrixOneOf0.VALID_STRING");
		private final Alternatives cAlternatives = (Alternatives)rule.eContents().get(1);
	...
	public class KEYWORDElements extends AbstractParserRuleElementFinder {
		private final ParserRule rule = (ParserRule) GrammarUtil.findRuleForName(getGrammar(), "githubwf.githubwf.ReusableWorkflowCallJobStrategyMatrixOneOf0.KEYWORD");
	...
	public class NullEnumElements extends AbstractElementFinder.AbstractEnumRuleElementFinder {
		private final EnumRule rule = (EnumRule) GrammarUtil.findRuleForName(getGrammar(), "githubwf.githubwf.ReusableWorkflowCallJobStrategyMatrixOneOf0.NullEnum");
	...
	private final ReusableWorkflowCallJobStrategyMatrixOneOf0Elements pReusableWorkflowCallJobStrategyMatrixOneOf0;
	private final ReusableWorkflowCallJobStrategyMatrixOneOf0PropertiesAbstractElements pReusableWorkflowCallJobStrategyMatrixOneOf0PropertiesAbstract;
	private final ValueElements pValue;
	private final ReusableWorkflowCallJobStrategyMatrixOneOf0AdditionalPropertiesElements pReusableWorkflowCallJobStrategyMatrixOneOf0AdditionalProperties;
	...
	@Inject
	public ReusableWorkflowCallJobStrategyMatrixOneOf0GrammarAccess(GrammarProvider grammarProvider,
			TerminalsGrammarAccess gaTerminals) {
		this.grammar = internalFindGrammar(grammarProvider);
		this.gaTerminals = gaTerminals;
		this.pReusableWorkflowCallJobStrategyMatrixOneOf0 = new ReusableWorkflowCallJobStrategyMatrixOneOf0Elements();
		this.pReusableWorkflowCallJobStrategyMatrixOneOf0PropertiesAbstract = new ReusableWorkflowCallJobStrategyMatrixOneOf0PropertiesAbstractElements();
		this.pValue = new ValueElements();
		this.pReusableWorkflowCallJobStrategyMatrixOneOf0AdditionalProperties = new ReusableWorkflowCallJobStrategyMatrixOneOf0AdditionalPropertiesElements();
		...
		this.tINT = (TerminalRule) GrammarUtil.findRuleForName(getGrammar(), "githubwf.githubwf.ReusableWorkflowCallJobStrategyMatrixOneOf0.INT");
		this.pVALID_STRING = new VALID_STRINGElements();
		this.tSTRING = (TerminalRule) GrammarUtil.findRuleForName(getGrammar(), "githubwf.githubwf.ReusableWorkflowCallJobStrategyMatrixOneOf0.STRING");
		this.tE_INT = (TerminalRule) GrammarUtil.findRuleForName(getGrammar(), "githubwf.githubwf.ReusableWorkflowCallJobStrategyMatrixOneOf0.E_INT");
		this.pKEYWORD = new KEYWORDElements();
		this.tE_DOUBLE = (TerminalRule) GrammarUtil.findRuleForName(getGrammar(), "githubwf.githubwf.ReusableWorkflowCallJobStrategyMatrixOneOf0.E_DOUBLE");
	}
	
	protected Grammar internalFindGrammar(GrammarProvider grammarProvider) {
		Grammar grammar = grammarProvider.getGrammar(this);
		while (grammar != null) {
			if ("githubwf.githubwf.ReusableWorkflowCallJobStrategyMatrixOneOf0".equals(grammar.getName())) {
				return grammar;
			}
	...
	//            '{'(matrix+=ReusableWorkflowCallJobStrategyMatrixOneOf0PropertiesAbstract ( "," matrix+=ReusableWorkflowCallJobStrategyMatrixOneOf0PropertiesAbstract)* )?'}'
	//    ;
	public ReusableWorkflowCallJobStrategyMatrixOneOf0Elements getReusableWorkflowCallJobStrategyMatrixOneOf0Access() {
		return pReusableWorkflowCallJobStrategyMatrixOneOf0;
	}
	
	public ParserRule getReusableWorkflowCallJobStrategyMatrixOneOf0Rule() {
		return getReusableWorkflowCallJobStrategyMatrixOneOf0Access().getRule();
	}
	
	//ReusableWorkflowCallJobStrategyMatrixOneOf0PropertiesAbstract returns ReusableWorkflowCallJobStrategyMatrixOneOf0PropertiesAbstract:
	//    =>ReusableWorkflowCallJobStrategyMatrixOneOf0AdditionalProperties;
	public ReusableWorkflowCallJobStrategyMatrixOneOf0PropertiesAbstractElements getReusableWorkflowCallJobStrategyMatrixOneOf0PropertiesAbstractAccess() {
		return pReusableWorkflowCallJobStrategyMatrixOneOf0PropertiesAbstract;
	}
	
	public ParserRule getReusableWorkflowCallJobStrategyMatrixOneOf0PropertiesAbstractRule() {
		return getReusableWorkflowCallJobStrategyMatrixOneOf0PropertiesAbstractAccess().getRule();
	}
	...
	//            additionalProperties=JsonDocument
	//    ;
	public ReusableWorkflowCallJobStrategyMatrixOneOf0AdditionalPropertiesElements getReusableWorkflowCallJobStrategyMatrixOneOf0AdditionalPropertiesAccess() {
		return pReusableWorkflowCallJobStrategyMatrixOneOf0AdditionalProperties;
	}
	
	public ParserRule getReusableWorkflowCallJobStrategyMatrixOneOf0AdditionalPropertiesRule() {
		return getReusableWorkflowCallJobStrategyMatrixOneOf0AdditionalPropertiesAccess().getRule();
	}
