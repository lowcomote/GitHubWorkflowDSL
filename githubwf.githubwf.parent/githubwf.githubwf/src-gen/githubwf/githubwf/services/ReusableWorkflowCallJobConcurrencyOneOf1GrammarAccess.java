...
@Singleton
public class ReusableWorkflowCallJobConcurrencyOneOf1GrammarAccess extends AbstractElementFinder.AbstractGrammarElementFinder {
	
	public class ReusableWorkflowCallJobConcurrencyOneOf1Elements extends AbstractParserRuleElementFinder {
		private final ParserRule rule = (ParserRule) GrammarUtil.findRuleForName(getGrammar(), "githubwf.githubwf.ReusableWorkflowCallJobConcurrencyOneOf1.ReusableWorkflowCallJobConcurrencyOneOf1");
		...
		////EClass ReusableWorkflowCallJobConcurrencyOneOf1
	...
	public class ConcurrencyPropertiesAbstractElements extends AbstractParserRuleElementFinder {
		private final ParserRule rule = (ParserRule) GrammarUtil.findRuleForName(getGrammar(), "githubwf.githubwf.ReusableWorkflowCallJobConcurrencyOneOf1.ConcurrencyPropertiesAbstract");
		...
		//ConcurrencyPropertiesAbstract returns ConcurrencyPropertiesAbstract:
	...
	public class ConcurrencyCancel_45in_45progressAbstractElements extends AbstractParserRuleElementFinder {
		private final ParserRule rule = (ParserRule) GrammarUtil.findRuleForName(getGrammar(), "githubwf.githubwf.ReusableWorkflowCallJobConcurrencyOneOf1.ConcurrencyCancel_45in_45progressAbstract");
		private final Alternatives cAlternatives = (Alternatives)rule.eContents().get(1);
		...
		//ConcurrencyCancel_45in_45progressAbstract returns ConcurrencyCancel_45in_45progressAbstract:
		//    =>ConcurrencyCancel_45in_45progressTypeNumber | ConcurrencyCancel_45in_45progressTypeString | ConcurrencyCancel_45in_45progressTypeInteger | ConcurrencyCancel_45in_45progressTypeBoolean | ConcurrencyCancel_45in_45progressTypeObject | ConcurrencyCancel_45in_45progressTypeArray | ConcurrencyCancel_45in_45progressTypeNull;
		@Override public ParserRule getRule() { return rule; }
	...
	public class ConcurrencyCancel_45in_45progressPropertiesAbstractElements extends AbstractParserRuleElementFinder {
		private final ParserRule rule = (ParserRule) GrammarUtil.findRuleForName(getGrammar(), "githubwf.githubwf.ReusableWorkflowCallJobConcurrencyOneOf1.ConcurrencyCancel_45in_45progressPropertiesAbstract");
		...
		//ConcurrencyCancel_45in_45progressPropertiesAbstract returns ConcurrencyCancel_45in_45progressPropertiesAbstract:
	...
	public class ValueElements extends AbstractParserRuleElementFinder {
		private final ParserRule rule = (ParserRule) GrammarUtil.findRuleForName(getGrammar(), "githubwf.githubwf.ReusableWorkflowCallJobConcurrencyOneOf1.Value");
		private final Alternatives cAlternatives = (Alternatives)rule.eContents().get(1);
	...
	public class ConcurrencyElements extends AbstractParserRuleElementFinder {
		private final ParserRule rule = (ParserRule) GrammarUtil.findRuleForName(getGrammar(), "githubwf.githubwf.ReusableWorkflowCallJobConcurrencyOneOf1.Concurrency");
		private final Group cGroup = (Group)rule.eContents().get(1);
	...
	public class ConcurrencyGroupElements extends AbstractParserRuleElementFinder {
		private final ParserRule rule = (ParserRule) GrammarUtil.findRuleForName(getGrammar(), "githubwf.githubwf.ReusableWorkflowCallJobConcurrencyOneOf1.ConcurrencyGroup");
		private final Group cGroup = (Group)rule.eContents().get(1);
	...
	public class ConcurrencyCancel_45in_45progressElements extends AbstractParserRuleElementFinder {
		private final ParserRule rule = (ParserRule) GrammarUtil.findRuleForName(getGrammar(), "githubwf.githubwf.ReusableWorkflowCallJobConcurrencyOneOf1.ConcurrencyCancel_45in_45progress");
	...
	public class EStringElements extends AbstractParserRuleElementFinder {
		private final ParserRule rule = (ParserRule) GrammarUtil.findRuleForName(getGrammar(), "githubwf.githubwf.ReusableWorkflowCallJobConcurrencyOneOf1.EString");
	...
	public class ConcurrencyCancel_45in_45progressTypeStringElements extends AbstractParserRuleElementFinder {
		private final ParserRule rule = (ParserRule) GrammarUtil.findRuleForName(getGrammar(), "githubwf.githubwf.ReusableWorkflowCallJobConcurrencyOneOf1.ConcurrencyCancel_45in_45progressTypeString");
		private final Group cGroup = (Group)rule.eContents().get(1);
	...
	public class ConcurrencyCancel_45in_45progressTypeIntegerElements extends AbstractParserRuleElementFinder {
		private final ParserRule rule = (ParserRule) GrammarUtil.findRuleForName(getGrammar(), "githubwf.githubwf.ReusableWorkflowCallJobConcurrencyOneOf1.ConcurrencyCancel_45in_45progressTypeInteger");
		private final Group cGroup = (Group)rule.eContents().get(1);
		private final Keyword cCancelInProgressKeyword_0 = (Keyword)cGroup.eContents().get(0);
		private final Keyword cColonKeyword_1 = (Keyword)cGroup.eContents().get(1);
		private final Assignment cCancel_45in_45progressAssignment_2 = (Assignment)cGroup.eContents().get(2);
	...
	public class ConcurrencyCancel_45in_45progressTypeNumberElements extends AbstractParserRuleElementFinder {
		private final ParserRule rule = (ParserRule) GrammarUtil.findRuleForName(getGrammar(), "githubwf.githubwf.ReusableWorkflowCallJobConcurrencyOneOf1.ConcurrencyCancel_45in_45progressTypeNumber");
		private final Group cGroup = (Group)rule.eContents().get(1);
		private final Keyword cCancelInProgressKeyword_0 = (Keyword)cGroup.eContents().get(0);
		private final Keyword cColonKeyword_1 = (Keyword)cGroup.eContents().get(1);
		private final Assignment cCancel_45in_45progressAssignment_2 = (Assignment)cGroup.eContents().get(2);
	...
	public class ConcurrencyCancel_45in_45progressTypeBooleanElements extends AbstractParserRuleElementFinder {
		private final ParserRule rule = (ParserRule) GrammarUtil.findRuleForName(getGrammar(), "githubwf.githubwf.ReusableWorkflowCallJobConcurrencyOneOf1.ConcurrencyCancel_45in_45progressTypeBoolean");
		private final Group cGroup = (Group)rule.eContents().get(1);
		private final Keyword cCancelInProgressKeyword_0 = (Keyword)cGroup.eContents().get(0);
		private final Keyword cColonKeyword_1 = (Keyword)cGroup.eContents().get(1);
		private final Assignment cCancel_45in_45progressAssignment_2 = (Assignment)cGroup.eContents().get(2);
	...
	public class ConcurrencyCancel_45in_45progressTypeObjectElements extends AbstractParserRuleElementFinder {
		private final ParserRule rule = (ParserRule) GrammarUtil.findRuleForName(getGrammar(), "githubwf.githubwf.ReusableWorkflowCallJobConcurrencyOneOf1.ConcurrencyCancel_45in_45progressTypeObject");
		private final Group cGroup = (Group)rule.eContents().get(1);
		...
		//            //Keywords
		//            '"cancel-in-progress"' ':'
		//            '{'(cancel_45in_45progress+=ConcurrencyCancel_45in_45progressPropertiesAbstract ( "," cancel_45in_45progress+=ConcurrencyCancel_45in_45progressPropertiesAbstract)* )?'}'
		//    ;
		@Override public ParserRule getRule() { return rule; }
	...
	public class ConcurrencyCancel_45in_45progressTypeArrayElements extends AbstractParserRuleElementFinder {
		private final ParserRule rule = (ParserRule) GrammarUtil.findRuleForName(getGrammar(), "githubwf.githubwf.ReusableWorkflowCallJobConcurrencyOneOf1.ConcurrencyCancel_45in_45progressTypeArray");
		private final Group cGroup = (Group)rule.eContents().get(1);
	...
	public class ConcurrencyCancel_45in_45progressTypeNullElements extends AbstractParserRuleElementFinder {
		private final ParserRule rule = (ParserRule) GrammarUtil.findRuleForName(getGrammar(), "githubwf.githubwf.ReusableWorkflowCallJobConcurrencyOneOf1.ConcurrencyCancel_45in_45progressTypeNull");
		private final Group cGroup = (Group)rule.eContents().get(1);
		private final Keyword cCancelInProgressKeyword_0 = (Keyword)cGroup.eContents().get(0);
		private final Keyword cColonKeyword_1 = (Keyword)cGroup.eContents().get(1);
		private final Assignment cCancel_45in_45progressAssignment_2 = (Assignment)cGroup.eContents().get(2);
	...
	public class EDoubleObjectElements extends AbstractParserRuleElementFinder {
		private final ParserRule rule = (ParserRule) GrammarUtil.findRuleForName(getGrammar(), "githubwf.githubwf.ReusableWorkflowCallJobConcurrencyOneOf1.EDoubleObject");
		private final Alternatives cAlternatives = (Alternatives)rule.eContents().get(1);
	...
	public class EBooleanObjectElements extends AbstractParserRuleElementFinder {
		private final ParserRule rule = (ParserRule) GrammarUtil.findRuleForName(getGrammar(), "githubwf.githubwf.ReusableWorkflowCallJobConcurrencyOneOf1.EBooleanObject");
		private final Alternatives cAlternatives = (Alternatives)rule.eContents().get(1);
	...
	public class ConcurrencyCancel_45in_45progressAdditionalPropertiesElements extends AbstractParserRuleElementFinder {
		private final ParserRule rule = (ParserRule) GrammarUtil.findRuleForName(getGrammar(), "githubwf.githubwf.ReusableWorkflowCallJobConcurrencyOneOf1.ConcurrencyCancel_45in_45progressAdditionalProperties");
		private final Group cGroup = (Group)rule.eContents().get(1);
	...
	public class JsonDocumentElements extends AbstractParserRuleElementFinder {
		private final ParserRule rule = (ParserRule) GrammarUtil.findRuleForName(getGrammar(), "githubwf.githubwf.ReusableWorkflowCallJobConcurrencyOneOf1.JsonDocument");
	...
	public class StringValueElements extends AbstractParserRuleElementFinder {
		private final ParserRule rule = (ParserRule) GrammarUtil.findRuleForName(getGrammar(), "githubwf.githubwf.ReusableWorkflowCallJobConcurrencyOneOf1.StringValue");
		private final Assignment cValueAssignment = (Assignment)rule.eContents().get(1);
	...
	public class ArrayValueElements extends AbstractParserRuleElementFinder {
		private final ParserRule rule = (ParserRule) GrammarUtil.findRuleForName(getGrammar(), "githubwf.githubwf.ReusableWorkflowCallJobConcurrencyOneOf1.ArrayValue");
		private final Group cGroup = (Group)rule.eContents().get(1);
	...
	public class NullValueElements extends AbstractParserRuleElementFinder {
		private final ParserRule rule = (ParserRule) GrammarUtil.findRuleForName(getGrammar(), "githubwf.githubwf.ReusableWorkflowCallJobConcurrencyOneOf1.NullValue");
		private final Assignment cValueAssignment = (Assignment)rule.eContents().get(1);
	...
	public class NumberValueElements extends AbstractParserRuleElementFinder {
		private final ParserRule rule = (ParserRule) GrammarUtil.findRuleForName(getGrammar(), "githubwf.githubwf.ReusableWorkflowCallJobConcurrencyOneOf1.NumberValue");
		private final Assignment cValueAssignment = (Assignment)rule.eContents().get(1);
	...
	public class ObjectValueElements extends AbstractParserRuleElementFinder {
		private final ParserRule rule = (ParserRule) GrammarUtil.findRuleForName(getGrammar(), "githubwf.githubwf.ReusableWorkflowCallJobConcurrencyOneOf1.ObjectValue");
		private final Group cGroup = (Group)rule.eContents().get(1);
	...
	public class BooleanValueElements extends AbstractParserRuleElementFinder {
		private final ParserRule rule = (ParserRule) GrammarUtil.findRuleForName(getGrammar(), "githubwf.githubwf.ReusableWorkflowCallJobConcurrencyOneOf1.BooleanValue");
		private final Assignment cValueAssignment = (Assignment)rule.eContents().get(1);
	...
	public class EDoubleElements extends AbstractParserRuleElementFinder {
		private final ParserRule rule = (ParserRule) GrammarUtil.findRuleForName(getGrammar(), "githubwf.githubwf.ReusableWorkflowCallJobConcurrencyOneOf1.EDouble");
		private final Alternatives cAlternatives = (Alternatives)rule.eContents().get(1);
		private final RuleCall cE_INTTerminalRuleCall_0 = (RuleCall)cAlternatives.eContents().get(0);
		private final RuleCall cE_DOUBLETerminalRuleCall_1 = (RuleCall)cAlternatives.eContents().get(1);
	...
	public class KeyValuePairElements extends AbstractParserRuleElementFinder {
		private final ParserRule rule = (ParserRule) GrammarUtil.findRuleForName(getGrammar(), "githubwf.githubwf.ReusableWorkflowCallJobConcurrencyOneOf1.KeyValuePair");
		private final Group cGroup = (Group)rule.eContents().get(1);
		private final Assignment cKeyAssignment_0 = (Assignment)cGroup.eContents().get(0);
		private final RuleCall cKeyEStringParserRuleCall_0_0 = (RuleCall)cKeyAssignment_0.eContents().get(0);
		private final Keyword cColonKeyword_1 = (Keyword)cGroup.eContents().get(1);
	...
	public class EBooleanElements extends AbstractParserRuleElementFinder {
		private final ParserRule rule = (ParserRule) GrammarUtil.findRuleForName(getGrammar(), "githubwf.githubwf.ReusableWorkflowCallJobConcurrencyOneOf1.EBoolean");
		private final Alternatives cAlternatives = (Alternatives)rule.eContents().get(1);
		private final Keyword cTrueKeyword_0 = (Keyword)cAlternatives.eContents().get(0);
		private final Keyword cFalseKeyword_1 = (Keyword)cAlternatives.eContents().get(1);
	...
	public class ConcurrencyCancel_45in_45progressItemsElements extends AbstractParserRuleElementFinder {
		private final ParserRule rule = (ParserRule) GrammarUtil.findRuleForName(getGrammar(), "githubwf.githubwf.ReusableWorkflowCallJobConcurrencyOneOf1.ConcurrencyCancel_45in_45progressItems");
	...
	public class VALID_STRINGElements extends AbstractParserRuleElementFinder {
		private final ParserRule rule = (ParserRule) GrammarUtil.findRuleForName(getGrammar(), "githubwf.githubwf.ReusableWorkflowCallJobConcurrencyOneOf1.VALID_STRING");
		private final Alternatives cAlternatives = (Alternatives)rule.eContents().get(1);
	...
	public class KEYWORDElements extends AbstractParserRuleElementFinder {
		private final ParserRule rule = (ParserRule) GrammarUtil.findRuleForName(getGrammar(), "githubwf.githubwf.ReusableWorkflowCallJobConcurrencyOneOf1.KEYWORD");
		private final Alternatives cAlternatives = (Alternatives)rule.eContents().get(1);
	...
	public class NullEnumElements extends AbstractElementFinder.AbstractEnumRuleElementFinder {
		private final EnumRule rule = (EnumRule) GrammarUtil.findRuleForName(getGrammar(), "githubwf.githubwf.ReusableWorkflowCallJobConcurrencyOneOf1.NullEnum");
	...
	private final ReusableWorkflowCallJobConcurrencyOneOf1Elements pReusableWorkflowCallJobConcurrencyOneOf1;
	...
	@Inject
	public ReusableWorkflowCallJobConcurrencyOneOf1GrammarAccess(GrammarProvider grammarProvider,
			TerminalsGrammarAccess gaTerminals) {
		this.grammar = internalFindGrammar(grammarProvider);
		this.gaTerminals = gaTerminals;
		this.pReusableWorkflowCallJobConcurrencyOneOf1 = new ReusableWorkflowCallJobConcurrencyOneOf1Elements();
		...
		this.tINT = (TerminalRule) GrammarUtil.findRuleForName(getGrammar(), "githubwf.githubwf.ReusableWorkflowCallJobConcurrencyOneOf1.INT");
		this.pVALID_STRING = new VALID_STRINGElements();
		this.tSTRING = (TerminalRule) GrammarUtil.findRuleForName(getGrammar(), "githubwf.githubwf.ReusableWorkflowCallJobConcurrencyOneOf1.STRING");
		this.tE_INT = (TerminalRule) GrammarUtil.findRuleForName(getGrammar(), "githubwf.githubwf.ReusableWorkflowCallJobConcurrencyOneOf1.E_INT");
		this.pKEYWORD = new KEYWORDElements();
		this.tE_DOUBLE = (TerminalRule) GrammarUtil.findRuleForName(getGrammar(), "githubwf.githubwf.ReusableWorkflowCallJobConcurrencyOneOf1.E_DOUBLE");
	}
	
	protected Grammar internalFindGrammar(GrammarProvider grammarProvider) {
		Grammar grammar = grammarProvider.getGrammar(this);
		while (grammar != null) {
			if ("githubwf.githubwf.ReusableWorkflowCallJobConcurrencyOneOf1".equals(grammar.getName())) {
				return grammar;
			}
	...
	//            concurrency=Concurrency
	//    ;
	public ReusableWorkflowCallJobConcurrencyOneOf1Elements getReusableWorkflowCallJobConcurrencyOneOf1Access() {
		return pReusableWorkflowCallJobConcurrencyOneOf1;
	}
	
	public ParserRule getReusableWorkflowCallJobConcurrencyOneOf1Rule() {
		return getReusableWorkflowCallJobConcurrencyOneOf1Access().getRule();
	}
