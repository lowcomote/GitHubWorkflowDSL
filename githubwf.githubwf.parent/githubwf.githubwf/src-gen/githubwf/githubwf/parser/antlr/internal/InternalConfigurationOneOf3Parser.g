 ...
 */
parser grammar InternalConfigurationOneOf3Parser;

options {
	tokenVocab=InternalConfigurationOneOf3Lexer;
...
// Entry rule entryRuleConfigurationOneOf3
entryRuleConfigurationOneOf3 returns [EObject current=null]:
	{ newCompositeNode(grammarAccess.getConfigurationOneOf3Rule()); }
	iv_ruleConfigurationOneOf3=ruleConfigurationOneOf3
	{ $current=$iv_ruleConfigurationOneOf3.current; }
	EOF;

// Rule ConfigurationOneOf3
ruleConfigurationOneOf3 returns [EObject current=null]
@init {
	enterRule();
}
@after {
...
// Entry rule entryRuleConfigurationOneOf3PropertiesAbstract
entryRuleConfigurationOneOf3PropertiesAbstract returns [EObject current=null]:
	...
	{ $current=$iv_ruleConfigurationOneOf3PropertiesAbstract.current; }
	EOF;

// Rule ConfigurationOneOf3PropertiesAbstract
ruleConfigurationOneOf3PropertiesAbstract returns [EObject current=null]
@init {
	enterRule();
}
@after {
	...
	(
		...
		{
			$current = $this_ConfigurationOneOf3AdditionalProperties_0.current;
			afterParserOrEnumRuleCall();
		}
	)
;
...
// Entry rule entryRuleConfigurationOneOf3AdditionalProperties
entryRuleConfigurationOneOf3AdditionalProperties returns [EObject current=null]:
	...
	{ $current=$iv_ruleConfigurationOneOf3AdditionalProperties.current; }
	EOF;

// Rule ConfigurationOneOf3AdditionalProperties
ruleConfigurationOneOf3AdditionalProperties returns [EObject current=null]
@init {
	enterRule();
}
@after {
