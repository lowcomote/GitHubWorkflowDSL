 ...
 */
parser grammar InternalNormalJobStrategyMatrixAdditionalPropertiesOneOf0Parser;

options {
	tokenVocab=InternalNormalJobStrategyMatrixAdditionalPropertiesOneOf0Lexer;
...
// Entry rule entryRuleNormalJobStrategyMatrixAdditionalPropertiesOneOf0
entryRuleNormalJobStrategyMatrixAdditionalPropertiesOneOf0 returns [EObject current=null]:
	...
	{ $current=$iv_ruleNormalJobStrategyMatrixAdditionalPropertiesOneOf0.current; }
	EOF;

// Rule NormalJobStrategyMatrixAdditionalPropertiesOneOf0
ruleNormalJobStrategyMatrixAdditionalPropertiesOneOf0 returns [EObject current=null]
@init {
	enterRule();
}
@after {
...
// Entry rule entryRuleNormalJobStrategyMatrixAdditionalPropertiesOneOf0Items
entryRuleNormalJobStrategyMatrixAdditionalPropertiesOneOf0Items returns [EObject current=null]:
	...
	{ $current=$iv_ruleNormalJobStrategyMatrixAdditionalPropertiesOneOf0Items.current; }
	EOF;

// Rule NormalJobStrategyMatrixAdditionalPropertiesOneOf0Items
ruleNormalJobStrategyMatrixAdditionalPropertiesOneOf0Items returns [EObject current=null]
@init {
	enterRule();
}
@after {
