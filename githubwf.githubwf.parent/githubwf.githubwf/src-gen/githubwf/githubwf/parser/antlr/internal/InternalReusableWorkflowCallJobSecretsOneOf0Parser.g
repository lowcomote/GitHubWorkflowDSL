...
entryRuleReusableWorkflowCallJobSecretsOneOf0 returns [EObject current=null]:
	...
	{ $current=$iv_ruleReusableWorkflowCallJobSecretsOneOf0.current; }
	EOF;

// Rule ReusableWorkflowCallJobSecretsOneOf0
ruleReusableWorkflowCallJobSecretsOneOf0 returns [EObject current=null]
@init {
	enterRule();
}
@after {
