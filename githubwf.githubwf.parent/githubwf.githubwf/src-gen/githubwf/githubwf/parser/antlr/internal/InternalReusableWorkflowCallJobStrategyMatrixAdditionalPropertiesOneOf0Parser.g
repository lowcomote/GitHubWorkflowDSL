...
entryRuleReusableWorkflowCallJobStrategyMatrixAdditionalPropertiesOneOf0 returns [EObject current=null]:
	...
	{ $current=$iv_ruleReusableWorkflowCallJobStrategyMatrixAdditionalPropertiesOneOf0.current; }
	EOF;

// Rule ReusableWorkflowCallJobStrategyMatrixAdditionalPropertiesOneOf0
ruleReusableWorkflowCallJobStrategyMatrixAdditionalPropertiesOneOf0 returns [EObject current=null]
@init {
	enterRule();
}
@after {
...
entryRuleReusableWorkflowCallJobStrategyMatrixAdditionalPropertiesOneOf0Items returns [EObject current=null]:
	...
	{ $current=$iv_ruleReusableWorkflowCallJobStrategyMatrixAdditionalPropertiesOneOf0Items.current; }
	EOF;

// Rule ReusableWorkflowCallJobStrategyMatrixAdditionalPropertiesOneOf0Items
ruleReusableWorkflowCallJobStrategyMatrixAdditionalPropertiesOneOf0Items returns [EObject current=null]
@init {
	enterRule();
}
@after {
