 ...
 */
parser grammar InternalGithubwfRootOnOneOf0Parser;

options {
	tokenVocab=InternalGithubwfRootOnOneOf0Lexer;
...
// Entry rule entryRuleGithubwfRootOnOneOf0
entryRuleGithubwfRootOnOneOf0 returns [EObject current=null]:
	{ newCompositeNode(grammarAccess.getGithubwfRootOnOneOf0Rule()); }
	iv_ruleGithubwfRootOnOneOf0=ruleGithubwfRootOnOneOf0
	{ $current=$iv_ruleGithubwfRootOnOneOf0.current; }
	EOF;

// Rule GithubwfRootOnOneOf0
ruleGithubwfRootOnOneOf0 returns [EObject current=null]
@init {
	enterRule();
}
@after {
