 ...
 */
parser grammar InternalContainerPortsItemsOneOf0Parser;

options {
	tokenVocab=InternalContainerPortsItemsOneOf0Lexer;
...
// Entry rule entryRuleContainerPortsItemsOneOf0
entryRuleContainerPortsItemsOneOf0 returns [EObject current=null]:
	...
	{ $current=$iv_ruleContainerPortsItemsOneOf0.current; }
	EOF;

// Rule ContainerPortsItemsOneOf0
ruleContainerPortsItemsOneOf0 returns [EObject current=null]
@init {
	enterRule();
}
@after {
