...
entryRuleReusableWorkflowCallJobSecretsOneOf1 returns [EObject current=null]:
	...
	{ $current=$iv_ruleReusableWorkflowCallJobSecretsOneOf1.current; }
	EOF;

// Rule ReusableWorkflowCallJobSecretsOneOf1
ruleReusableWorkflowCallJobSecretsOneOf1 returns [EObject current=null]
@init {
	enterRule();
}
@after {
