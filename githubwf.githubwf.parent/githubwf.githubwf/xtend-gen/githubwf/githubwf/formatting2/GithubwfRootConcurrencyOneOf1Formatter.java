...
public class GithubwfRootConcurrencyOneOf1Formatter extends AbstractFormatter2 {
  @Inject
  @Extension
  private GithubwfRootConcurrencyOneOf1GrammarAccess _githubwfRootConcurrencyOneOf1GrammarAccess;

  protected void _format(final GithubwfRootConcurrencyOneOf1 githubwfRootConcurrencyOneOf1, @Extension final IFormattableDocument document) {
    document.<Concurrency>format(githubwfRootConcurrencyOneOf1.getConcurrency());
  }
  ...
  public void format(final Object concurrency, final IFormattableDocument document) {
    if (concurrency instanceof XtextResource) {
      ...
      return;
    } else if (concurrency instanceof GithubwfRootConcurrencyOneOf1) {
      _format((GithubwfRootConcurrencyOneOf1)concurrency, document);
      return;
